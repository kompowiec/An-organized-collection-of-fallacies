...
<stylenode LOCALIZED_TEXT="default" ICON_SIZE="12.0 pt" COLOR="#000000" STYLE="fork" ID="ID_1104265336">
...
<header/>    
    ...
    <div class="content clearfix">
      ...
      <h1 type="text/css" class="lftitle">
        Argument by Fast Talking
      </h1>
      <header/>
      ...
      <div class="content clearfix">
        ...
        <p class="Body">
          <strong>Example #1:</strong>&nbsp;(to be read extremely fast)
        </p>
        <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
        ...
        <p class="Body">
          <strong>Explanation:</strong>&nbsp;There is absolutely no evidence in the above claim, and if you read it quickly and clearly, you would persuade more people than if you read it like one of the Beverly Hillbillies.&nbsp;&nbsp;If your intent was to persuade others by not giving them time to process what you have said, then you would be guilty of this fallacious tactic.
        </p>
        <p class="Body">
          <strong>Example #2:</strong>&nbsp;(same example - to be read extremely fast)
        </p>
        <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
          I hereby submit that it is crystal clear that there is only one true God, without question, without reserve, without hesitation I can say this because I know the truth and I am here to share it with you.&nbsp;&nbsp;Praise Allah!
        </p>
        <p class="Body">
          <strong>Explanation:</strong>&nbsp;This time, as the one evaluating the argument, if you allow the rapid pace of the delivery of the argument to serve as evidence for the claim, you are committing the fallacy.&nbsp;&nbsp;Perhaps the arguer does sound confident, and perhaps you are embarrassed to ask him to repeat the argument or slow down; therefore, you just accept it.&nbsp;&nbsp;Either way, that is fallacious reasoning.
        </p>
        <p class="Body">
          <strong>Exception:</strong>&nbsp;Naturally fast talkers most likely have no intent to deceive, and if you consciously give no undue weight to the claims of a natural fast talker, then no fallacy has been committed.
        </p>
        <p class="Body">
          <strong>Tip:</strong>&nbsp;Work on your pace as a part of your speaking.&nbsp;&nbsp;It should be just slow enough where you do not lose your audience, and no slower, unless going for a dramatic effect.
        </p>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Concluding that one thing caused another, simply because they are regularly associated.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I hope the fallacious reasoning here is very clear and needs no explanation.&nbsp;
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;While AIDS is found in a much larger percentage of the homosexual population than in the heterosexual population, we cannot conclude that homosexuality is the cause of AIDS, any more than we can conclude that heterosexuality is the cause of pregnancy.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;When strong evidence is provided for causation, it is not a fallacy.
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;To establish causality you need to show three things: 1) that X came before Y, 2) that the observed relationship between X and Y didn't happen by chance alone, and 3) that there is nothing else that accounts for the X then Y relationship.
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Johnson, R. H., &amp; Blair, J. A. (2006). <i>Logical Self-defense</i>. IDEA.
        </div>
      </div>
    </div>
  </body>
...
<node TEXT="Correlation does not imply causation" ID="ID_28882714" CREATED="1618490032304" MODIFIED="1636960225329"><richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;Claiming that because event Y followed event X, event Y must have been caused by event X, without properly establishing causality.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <div class="content clearfix">
      ...
      <p class="Body">
        <strong>Example #1: </strong>Doug is convinced he has lucky underwear. One time when he forgot to put on his lucky underwear, he got a parking ticket. Doug concludes that because he forgot to wear his lucky underwear, he got the ticket. Doug doesn't wash his lucky underwear often. This part isn't relevant to the example, but it is disturbing nonetheless.
      </p>
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Doug is not making any attempts to determine the most probabilistic causal factors for getting the parking ticket. Instead, largely because of the <em>confirmation bias</em>, he is making a claim of causality based on the order of events (first he forgot his lucky underwear, then he got the ticket.)
      </p>
      <p class="Body">
        <strong>Example #2:&nbsp;</strong>
      </p>
      ...
      <p class="Body">
        <strong>Exception:</strong>&nbsp;If one claims that Y caused X by adding additional details that properly establish causality, this fallacy would not apply.
      </p>
      <p class="Body">
        <strong>Fun Fact:</strong>&nbsp;There is some non-mystical truth to the law of attraction. That which you obsess over you are more likely to adjust your behaviors in a way that will help make your obsession a reality. For example, if you want to graduate college more than anything, you will most likely study harder, ask for extra help, and blow off fewer classes. No magic required.
      </p>
    </div>
    <strong>References:</strong>

    <div class="small" style="padding-left: 22px; text-indent: -22px">
      Post Hoc, Ergo Propter Hoc on JSTOR. (n.d.). Retrieved July 16, 2020, from <a href="https://www.jstor.org/stable/20126985?seq=1">https://www.jstor.org/stable/20126985?seq=1</a>
    </div>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Reasoning that, in a situation that is pure random chance, the outcome can be affected by previous outcomes.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Situation X is purely random.</em></font><br/><font color="rgb(52, 73, 94)"><em>Situation X resulted in Y.</em></font><br/><font color="rgb(52, 73, 94)"><em>Y is less likely to be the result next time.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>I have flipped heads five times in a row.&nbsp;&nbsp;As a result, the next flip will probably be tails.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The odds for each and every flip are calculated independently from other flips.&nbsp;&nbsp;The chance for each flip is 50/50, no matter how many times heads came up before.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Eric: For my lottery numbers, I chose 6, 14, 22, 35, 38, 40.&nbsp;&nbsp;What did you choose?</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Steve: I chose 1, 2, 3, 4, 5, 6.</em></font>
    </p>
    <p style="padding-left: 40px">
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Maury: Please put all my chips on red 21.</em></font>
    </p>
    <p style="padding-left: 40px">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Statistically, Carlos and Marta are more likely to lose the next game since a) their &quot;streak&quot; is probability-based, not talent-based and b) the odds are against them in the game of craps. Carlos is incorrectly viewing the string of wins as a streak that is more likely to continue than not.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;The belief that you are &quot;on fire&quot; (i.e., performing exceptionally well) can lead to better performance, via the <i>self-fulfilling prophecy</i>. There are times when thinking too critically can negatively affect performance.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;As mentioned, a streak of favorable talent-based actions can be the result of superior physical and mental performance.&nbsp;
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    ...
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Claim is made.</em></font><br/><font color="rgb(52, 73, 94)"><em>Statistics are referenced, reason is ignored.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, the statistical answer is used to support or reject the claim.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>&nbsp;The best example of this fallacy is presented by the person who coined this term, Nassim Nicholas Taleb in his 2007 book, <i>The Black Swan</i>.&nbsp;&nbsp;There are two people:
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Dr. John, who is regarded as a man of science and logical thinking.</em></font>
    </p>
    <p style="padding-left: 40px">
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Lolita: Since about half the people in the world are female, the chances of the next person to walk out that door being female is about 50/50.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Celina: Do you realize that is the door to Dr. Vulvastein, the gynecologist?</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Lolita is focusing on pure statistics while ignoring actual reason.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;See the explanation for example #1.
    </p>
    <p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Taleb, N. N. (2010). <i>The Black Swan: Second Edition: The Impact of the Highly Improbable Fragility&quot;</i>. Random House Publishing Group.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Ascribing a cause where none exists in situations where natural fluctuations exist while failing to account for these natural fluctuations.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Poulton, E. C. (1994). <i>Behavioral Decision Theory: A New Approach</i>. Cambridge University Press.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1542145554" STARTINCLINATION="5337;0;" ENDINCLINATION="5337;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;Assuming a single cause or reason when there were actually multiple causes or reasons.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;An explanation that posits one minor factor, out of several that contributed, as its sole cause. This fallacy also occurs when an explanation is requested, and the one that is given is not sufficient to entirely explain the incident yet it is passed off as if it is sufficient.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Assuming that spanking did contribute to Billy's murderous behavior as an adult (which is a very weak assumption), to sell that as the cause is extremely fallacious.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Walton, D. N. (1992). <i>Slippery Slope Arguments</i>. Clarendon Press.
        </div>
      </div>
      <p>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1001664273" STARTINCLINATION="1053;0;" ENDINCLINATION="1053;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    ...
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X and Y are compared by several criteria.</em></font><br/><font color="rgb(52, 73, 94)"><em>A conclusion is made based on only the criteria that produce the desired outcome.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Forshaw, M. (2012). <i>Critical Thinking For Psychology: A Student Guide</i>. John Wiley &amp; Sons.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Making causal connections or correlations between two events not based on logic or evidence, but primarily based on superstition.&nbsp;&nbsp;Magical thinking often causes one to experience <a href="http://en.wikipedia.org/wiki/Irrational">irrational</a>&nbsp;&nbsp;fear of performing certain acts or having certain thoughts because they assume a correlation with their acts and threatening calamities.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Event A occurs.</em></font><br/><font color="rgb(52, 73, 94)"><em>Event B occurs.</em></font><br/><font color="rgb(52, 73, 94)"><em>Because of superstition or magic, event A is causally connected to or correlated with event B.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Mr. Governor issues a proclamation for the people of his state to pray for rain.&nbsp;&nbsp;Several months later, it rains.&nbsp;&nbsp;Praise the gods!</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Suggesting that appealing to the gods for rain via prayer or dance is just the kind of thing crazy enough to get you elected president of the United States, but there is absolutely no logical reason or evidence to support the claim that appealing to the gods will make it rain.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Hutson, M. (2012). <i>The 7 Laws of Magical Thinking: How Irrational Beliefs Keep Us Happy, Healthy, and Sane</i>. Penguin.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1844366471" STARTINCLINATION="1447;0;" ENDINCLINATION="1447;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;There are very few clear lines we can draw between categories in any area of life.&nbsp;&nbsp;Categories are human constructs that we create to help us make sense of things, yet they often end up creating more confusion by tricking us into thinking abstract concepts actually exist.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Offering a poorly supported claim about what might have happened in the past or future, if (the hypothetical part) circumstances or conditions were different.&nbsp;&nbsp;The fallacy also entails treating future hypothetical situations as if they are fact.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>If event X did happen, then event Y would have happened (based only on speculation).</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>John, if you would have taken a shower more often, you would still be dating Tina.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Past hypotheticals that are stated as fact are most often nothing more than one possible outcome of many.&nbsp;&nbsp;One cannot ignore probabilities when making these kinds of statements.&nbsp;&nbsp;Perhaps Tina likes the smell of man sweat.&nbsp;&nbsp;Perhaps Tina would have still preferred Renaldo over John despite John's personal hygiene because of Renaldo's enormous intellect.
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Moore, W. E. (1967). <i>Creative and Critical Thinking</i>. Houghton Mifflin.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The thought of people torturing babies for fun immediately brings up unpleasant images (in sane people).&nbsp;&nbsp;The actual argument (implied) is that there are objective (universal) rights and wrongs (morality).&nbsp;&nbsp;The argument is worded in such a way to connect the argument's conclusions (that there is objective morality) with the idea that torturing babies for fun is wrong (this is also a <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Non-Sequitur" target="fallacy" data-toggle="tooltip" title="" data-original-title="When the conclusion does not follow from the premises.  In more informal reasoning, it can be when what is presented as evidence or reason is irrelevant or adds very little support to the conclusion." aria-describedby="tooltip120619">non sequitur</a>&nbsp;&nbsp;fallacy</i>).&nbsp;&nbsp;No matter how we personally feel about a horrible act, our feelings are not a valid substitution for an objective reason behind <i>why</i>&nbsp;&nbsp;the act is horrible.
    </p>
    <p class="Body">
      <strong>Exceptions:</strong>&nbsp;Appealing to emotions is a very powerful and necessary technique in persuasion.&nbsp;&nbsp;We are emotional creatures; therefore, we often make decisions and form beliefs erroneously based on emotions, when reason and logic tell us otherwise.&nbsp;&nbsp;However, using appeals to emotion as a backup to rational and logical arguments is not only valid, but a skill possessed by virtually every great communicator.&nbsp;
    </p>
    <p class="Body">
      <strong>Tip: </strong>By appealing to both the brain and the heart, you will persuade the greatest number of people.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;&nbsp;When fear, not based on evidence or reason, is being used as the primary motivator to get others to accept an idea, proposition, or conclusion.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Making an argument based on the worst-case scenario rather than the most probable scenario, allowing fear to prevail over reason.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Every decision you make has both costs and benefits.&nbsp;&nbsp;Fallacious arguments, like the one above, will attempt to get you to make a decision out of fear rather than reason, thus increasing the <i>perceived</i>&nbsp;&nbsp;cost of choosing not to wear a helmet.&nbsp;&nbsp;Of course, the cost of wearing a helmet while playing chess is peer ridicule of historic proportions.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;You may be great at washing dishes, but that fact in itself is not a sufficient reason for you being the one to wash the dishes.&nbsp;&nbsp;Is it necessary for someone as skilled at dish-washing as you to do the job, or is it a mindless job that anyone can do just fine?
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Sincere praise is not flattery and is universally appreciated<a title="" href="http://www.logicallyfallacious.com/index.php/logical-fallacies/33-appeal-to-flattery#_ftn1"><sup>[1]</sup></a>.&nbsp;&nbsp;However, even sincere praise in place of reason in an argument is a fallacy, unless the argument is directly related to the sincere praise.
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Claiming that something that is new or modern is superior to the status quo, based exclusively on its newness.
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;The attempt to distract from the truth of the conclusion by the use of pity.
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Being pathetic does not absolve one from his or her crimes, even when he or she is a ridiculously-adorable puppy.
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Avoid pity in argumentation.&nbsp;&nbsp;It is a clear indicator that you have weak evidence for your argument.
    </p>
  </body>
</html>
</richcontent>
  ...
  <body>
    <div class="content clearfix">
      <p class="uk-text-large" style="margin-top: -15px; font-style: italic">
        <strong>Description: </strong>Presenting the argument in such a way that makes the argument look ridiculous, usually by misrepresenting the argument or the use of exaggeration.
      </p>
      <p class="Body">
        <strong>Logical Form:</strong>
      </p>
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Comparing the belief in God to belief in the Easter Bunny is an attempt at ridicule and not a good argument.&nbsp;&nbsp;In fact, this type of fallacy usually shows desperation in the one committing the fallacy.
      </p>
      <p class="Body">
        <strong>Example #2:</strong>
      </p>
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;It is ridiculous to think that we come from pond scum, and it is not true.&nbsp;&nbsp;It is more accurate to say that we come from exploding stars as every atom in our bodies was once in a star.&nbsp;&nbsp;By creating a ridiculous and misleading image, the truth claim of the argument is overlooked.
      </p>
      <p class="Body">
      ...
      <p>
        <strong>Tip:</strong>&nbsp;Do your best to maintain your composure when someone commits this fallacy at your expense.&nbsp;&nbsp;Remember, they are the ones who have committed the error in reasoning.&nbsp;&nbsp;Tactfully point it out to them.
      </p>
    </div>
    <h1 class="lftitle">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Eemeren, F. H. van, Garssen, B., &amp; Meuffels, B. (2009). <i>Fallacies and Judgments of Reasonableness: Empirical Research Concerning the Pragma-Dialectical Discussion Rules</i>. Springer Science &amp; Business Media.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1706945405" STARTINCLINATION="1758;0;" ENDINCLINATION="1758;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
</node>
...
<html>
  ...
  <body>
    <div class="content clearfix">
      <p class="Body">
        <strong>Description:</strong>&nbsp;When one is either implicitly or explicitly encouraged to consider loyalty when evaluating the argument when the truth of the argument is independent of loyalty. Alternatively, one considers loyalty in concluding that the argument is true, false, or not worth investigating.
      </p>
      <p class="Body">
        <strong>Logical Form:</strong>
      </p>
      ...
      <p>
        <strong>Tip:</strong>&nbsp;Be loyal to truth and reason, even if it is seen as disloyalty to an ideology.
      </p>
    </div>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Substituting spite (petty ill will or hatred with the disposition to irritate, annoy, or thwart) for evidence in an argument, or as a reason to support or reject a claim.
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Be happy. Avoid spite in all of its forms.
    </p>
  </body>
</html>
</richcontent>
...
<node TEXT="Every Schoolboy Knows" ID="ID_877519680" CREATED="1642351603796" MODIFIED="1642351607233"/>
</node>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Compelling language or rhetoric can be useful when used in addition to evidence or strong claims.
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is a common fallacy among those who argue for the supernatural or anything else not falsifiable.&nbsp;&nbsp;If Joe was not that reasonable of a thinker, then he might start to question the validity of his position, not based on any new counter evidence presented, but a direct attack on his self-confidence.&nbsp;&nbsp;Fortunately for Joe, he holds no dogmatic beliefs and is perfectly aware of the difference between possibilities and probabilities (see also <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Appeal-to-Possibility" target="fallacy" data-toggle="tooltip" title="" data-original-title="When a conclusion is assumed not because it is probably true, but because it is possible that it is true, no matter how improbable.">appeal to possibility</a></i>).
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;When one claims certainty for something where certainty is unknowable, it is your duty to point it out.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Have confidence that you are probably or even very probably right, but avoid dogmatic certainty at all costs in areas where certainty is unknowable.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Arguing that your conclusion, solution, or proposition is right based on the fact that something must be done, and your solution is &quot;something.&quot;
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Do your best to avoid situations of desperation where emotion very often takes the lead over reason.&nbsp;&nbsp;Although not all desperate situations can be avoided, many can, by proper planning and foresight.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;Evaluating an argument based on &quot;intuition&quot; or &quot;gut feeling&quot; that is unable to be articulated, rather than evaluating the argument using reason.
    </p>
    <p class="Body">
      <strong>Logical Forms:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Besides Nick's flat out rejection of a fact, Nick is evaluating Suzy's refutation based on what feels wrong to him. Nick is abandoning the reasoning process.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Maura makes a good argument as to why Phillip should not buy any more tickets, but Philip abandons the reasoning process and makes an appeal to his intuition.
    </p>
    <p class="Body">
      <strong>Exception: </strong>This doesn't include arguments where subjective feeling plays a significant role.
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Loaded or emotive terms used to attach value or moral goodness to believing the proposition.
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;<em>Prejudicial language</em>&nbsp;can be a powerful and effective persuasion tool. Use it in addition to a well-reasoned argument, not in place of one.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Damer, T. E. (2008). <i>Attacking Faulty Reasoning: A Practical Guide to Fallacy-Free Arguments</i>. Cengage Learning.
        </div>
      </div>
    </div>
  </body>
...
<node ID="ID_742587298" CREATED="1618490216049" MODIFIED="1642698079410"><richcontent TYPE="NODE">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1001664273" STARTINCLINATION="473;0;" ENDINCLINATION="473;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Basing the truth claim of an argument on the origin of its claims or premises.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;That fact that Lisa may have been brainwashed as a child, is irrelevant to the claim that people are generally good.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip: </strong>Remember that considering the source is often a useful heuristic in quickly assessing if the claim is probably true or not, but dismissing the claim or accepting it as true based on the source is fallacious.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Engel, S. M., Soldan, A., &amp; Durand, K. (2007). <i>The Study of Philosophy</i>. Rowman &amp; Littlefield.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1001664273" STARTINCLINATION="567;0;" ENDINCLINATION="567;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When the source is viewed negatively because of its association with another person or group who is already viewed negatively.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Making the assumption that Delores is an extreme feminist simply because she supports a policy that virtually every man and woman also supports, is fallacious.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The fact that Pol Pot and Frankie share one particular view does not mean they are identical in other ways unrelated, specifically, being a very bad man.&nbsp;&nbsp;Pol Pot was not a bad man <i>because</i>&nbsp;&nbsp;he was against religion, he was a bad man for his genocidal actions.
    </p>
    <p class="Body">
      <strong>Example #3:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Lindi and Jonah are making an extraordinary claim and offering no evidence to support their claim. They are using Galileo in an attempt to get the audience to doubt their skepticism about the claim.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Although Sidney did not use the exact example of Galileo, the fallacy is the same. Any reference to a similar story counts.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Using Galileo or similar success stories to serve as effective inspirational anecdotes to encourage people to reach outside their comfort zone is not fallacious. It does not mean, however, that because they succeeded, that everyone else will or even can.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Remember that for every Galileo, there are millions of cranks, quacks, and wackos, and statistically speaking, those who use the Galileo defense are one of the latter.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Variation:</strong>&nbsp;The <em>appeal to ethos</em>&nbsp;involves rejection of an argument based on a character attack of the person making the argument.
    </p>
    <p class="Body" style="padding-left: 40px">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Walton, D. (1998). <i>Ad Hominem Arguments</i>. University of Alabama Press.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1706945405" STARTINCLINATION="1166;0;" ENDINCLINATION="1166;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#000000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1726413040" STARTINCLINATION="3498;0;" ENDINCLINATION="3498;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This is a common one in recent history.&nbsp;&nbsp;It is the assumption or admission that two or more groups, individuals, or ideas of groups or individuals, are equal, of equal value, or both true, based on the recent phenomenon of political correctness, which is defined as, <i>a term which denotes language, ideas, policies, and behavior seen as seeking to minimize social and institutional offense in occupational, gender, racial, cultural, sexual orientation, certain other religions, beliefs or ideologies, disability, and age-related contexts, and, as purported by the term, doing so to an excessive extent.</i>

    <p class="Body">
      This can be seen as an over-correction of<i>&nbsp;<a href="https://www.logicallyfallacious.com/logicalfallacies/Stereotyping-the-fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="The general beliefs that we use to categorize people, objects, and events while assuming those beliefs are accurate generalizations of the whole group.">stereotyping (the fallacy).</a><br/></i>
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;While many things are possible, including a four-year-old American girl being a terrorist, profiling works on probabilities. Inserting political correctness here goes against reason in asserting that every person is just as likely to be a terrorist.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Are any and all religiously-based behaviors acceptable?&nbsp;&nbsp;Must we allow all expression of religion?&nbsp;&nbsp;Where do we draw the line and why?
    </p>
    <p class="Body">
...
<node TEXT="Tu quoque" ID="ID_1433906146" CREATED="1618499250279" MODIFIED="1642766857392">
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#000000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1445512070" STARTINCLINATION="2264;0;" ENDINCLINATION="2264;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Claiming the argument is flawed by pointing out that the one making the argument is not acting consistently with the claims of the argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The fact Jimmy Swaggart likes to play a round of bedroom golf with some local entrepreneurial ladies, is not evidence for sexual immorality <i>in general</i>, only that <i>he is</i>&nbsp;sexually immoral.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;If Jimbo insisted that his actions were in line with sexual morality, then it would be a very germane part of the argument.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Again, admit when your lack of self-control or willpower has nothing to do with the truth claim of the proposition.&nbsp;&nbsp;The following is what I remember my dad telling me about smoking (he smoked about four packs a day since he was 14).
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The belief that if a source is considered trustworthy or untrustworthy, then any information from that source must be true or false, respectively. This is problematic because each argument, claim, or proposition should be evaluated on its own merits.

    <p class="Body">
      This doesn't include trusting <strong>in</strong>&nbsp;someone or something. For example, when we trust our children that they will make the right decisions in a certain situation, we are not using fallacious reasoning. When we trust that our seat belts will work when they need to, we are not using fallacious reasoning. When we trust that our puppy will leave us a gift on the carpet if we don't let him out by 7:00 AM, we are not using fallacious reasoning. When we express trust in someone, we are essentially expressing a degree of confidence, <strong>not making an absolute claim of something being true or false</strong>.
    </p>
    <p class="Body">
      <strong>Logical Forms:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The <i>Global Enquirer</i>&nbsp;might not be known for its high-quality journalism and truthful reporting. However, even the most untrustworthy sources sometimes share true information. While it might be a good heuristic (rule of thumb) to be highly skeptical of any claims from such an untrustworthy source, such claims cannot be so confidently dismissed without a good reason.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;As long as one is claiming a degree of confidence instead of assuming true or false, there is no fallacy. Trustworthiness does impact the level of confidence one should have, but not certainty.
    </p>
    <p class="Body">
      <strong>Tip:&nbsp;</strong>Try to keep your level of confidence proportionate to your level of trust.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Judging two situations by different standards when, in fact, you should be using the same standard. This is used in argumentation to unfairly support or reject an argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The husband is holding his wife to a different standard without articulating the standard. Most people would also agree that the standard is unfair.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When a person attempts to justify an action against another person because the other person did take or would take the same action against him or her.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This is a combination of <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Circular-Reasoning" target="fallacy" data-toggle="tooltip" title="" data-original-title="A type of reasoning in which the proposition is supported by the premises, which is supported by the proposition, creating a circle in reasoning where no useful information is being shared.  This fallacy is often quite humorous.">circular reasoning</a></i>&nbsp;&nbsp;and the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Genetic-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Basing the truth claim of an argument on the origin of its claims or premises.">genetic fallacy</a></i>. It is the assumption and assertion that an argument is flawed or false because of the arguer's suspected motives, social identity, or other characteristic associated with the arguer's identity.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Mom is doing her best to advise her daughter that she should be a bit more sexually reserved with her male suitors, cautioning her that she is unlikely to get any commitments unless she holds back sex. Although the claim is indeed dubious, the daughter assumes that it is wrong because of the source (her mother) and her mother's suspected motives (to get her married). So the mother must be wrong (assumption) because of her motives, and it is because of her motives that she is wrong (<i><a href="https://www.logicallyfallacious.com/logicalfallacies/Circular-Reasoning" target="fallacy" data-toggle="tooltip" title="" data-original-title="A type of reasoning in which the proposition is supported by the premises, which is supported by the proposition, creating a circle in reasoning where no useful information is being shared.  This fallacy is often quite humorous.">circular reasoning</a></i>&nbsp;and the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Genetic-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Basing the truth claim of an argument on the origin of its claims or premises.">genetic fallacy</a></i>).
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;There is no exception; however, in some cases it is fair to cast doubt on the argument based on the identity of the person making the argument. This is a heuristic that may be useful, but problematic in critical argumentation.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If you want a glass of milk, just buy the glass of milk, you don't need the whole cow (wait, did I just support prostitution?)
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Cindy-Lou did not address the concern, but essentially threatened Gertrude to shut up or lose her job. This example might also be seen as <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Appeal-to-Force" target="fallacy" data-toggle="tooltip" title="" data-original-title="When force, coercion, or even a threat of force is used in place of a reason in an attempt to justify a conclusion.">appeal to force</a></i>&nbsp;.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Remember the old saying about the grass being greener on the other side.
    </p>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Attacking the person making the argument, rather than the argument itself, when the attack on the person is completely irrelevant to the argument the person is making.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Attempting to get the audience to devalue reason and intellectual discourse, or devaluing reason and intellectual discourse based on the rhetoric of an arguer.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;It is a common persuasion technique to get people in an emotional state and have them make an emotional decision while in that state. This is exactly what Anthony is doing here while undermining the importance of critical thinking.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When following the law is assumed to be the morally correct thing to do, without justification, or when breaking the law is assumed to be the morally wrong thing to do, without justification.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Civil disobedience is just one example of something that is illegal but does not have to be immoral. Laws are created for many reasons, and only some are created for &quot;moral&quot; reasons (according to someone's moral code).
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Again, the law and one's moral code are not the same things. While there does tend to be overlap, assuming illegal is immoral or legal is moral without a rational argument connecting the two concepts, is fallacious.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Sometimes what is illegal is clearly immoral, and no justification is required. For example, if someone were to say, &quot;How could you kick that old lady while laughing? That is a horrible thing to do, and you can go to jail!&quot;
    </p>
    <p>
      <strong>Tip:&nbsp;</strong>Laws become archaic when they do not keep up with social norms and cultural changes. What was once deemed &quot;immoral&quot; could easily change to &quot;moral&quot; within a few years and vice versa. Never simply assume that laws are good and right; demand justification.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The misconception that previous generations had superior wisdom to modern man, thus conclusions that rely on this wisdom are seen accepted as true or more true than they actually are.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Asserting that those who disagree with you must be wrong and not thinking straight, primarily based on the fact that they are the opposition.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Person 1 is asserting X.<br/>Person 1 is the opposition.<br/>Therefore, X must be wrong.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>President Trump said that he was proud of the children who participated in this year's Special Olympics. Those kids are a bunch of losers.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is an extreme example of a very real example that we have all seen since around early 2016. Those who passionately hate Trump, reflexively disagree with everything he says and does, associating the truth of his statement with the feelings they have for him. This is not reasonable thinking.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>The Democrats support more aggressive gun control laws. Can you believe they want to deny repeat offenders and those on the terrorist watch list their rights?</em></font>
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When one's argument is evaluated based on their physical or social identity, i.e., their social class, generation, ethnic group, gender or sexual orientation, profession, occupation or subgroup when the strength of the argument is independent of identity.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;S.J. Sam is making an empirical claim about a hiring preference for non-Asians. Cindy has refuted the claim that is independent of her physical or social identity (i.e., her ability to refute the argument is not dependent upon her being Asian). S.J. Sam rejects her rebuttal because she is not Asian. In addition, he pulls a <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Red-Herring" target="fallacy" data-toggle="tooltip" title="" data-original-title="Attempting to redirect the argument to another issue that to which the person doing the redirecting can better respond. While it is similar to the avoiding the issue fallacy, the red herring is a deliberate diversion of attention with the intention of trying to abandon the original argument.">red herring</a></i>&nbsp;by changing the argument to &quot;knowing the struggles&quot; of the Asian community.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The implication here is that men have nothing to add to the discussion. Ideas to reduce gender discrimination are independent of gender, that is, both men and women can have equally valid arguments.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;A requirement for this fallacy is &quot;when the strength of the argument is independent of identity.&quot; There are arguments that do rely on identity. For example, claims of feeling and perception could be unique to certain groups.
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Before you exclude any group from your discussions or ignore their arguments based on their physical or social group, make sure you have a solid reason.
    </p>
  </body>
</html>
</richcontent>
...
<node TEXT="argumentum ad hominem (Circumstantial)" ID="ID_177427390" CREATED="1637053919847" MODIFIED="1642678774072">
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#000000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1001664273" STARTINCLINATION="1359;0;" ENDINCLINATION="1359;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Insisting that a claim is true simply because a valid authority or expert on the issue said it was true, without any other supporting evidence offered. Also see the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Appeal-to-False-Authority" target="fallacy" data-toggle="tooltip" title="" data-original-title="Using an alleged authority as evidence in your argument when the authority is not really an authority on the facts relevant to the argument.">appeal to false authority</a></i>&nbsp;&nbsp;.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Richard Dawkins certainly knows about evolution, and he can confidently tell us that it is true, but that doesn't make it true. What makes it true is the preponderance of evidence for the theory.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Question authority -- or become the authority that people look to for answers.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;We can all admire accomplishment and success, but this is irrelevant to cat-juggling.&nbsp;&nbsp;There are many accomplished and successful people who are immoral, mean, insensitive, hateful, liars,&nbsp;&nbsp;miserable, and just plain wrong about a great many things.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Concluding that the truth value of the argument is true or false based on the financial status of the author of the argument or the money value associated with the truth. The <i>appeal to poverty</i>&nbsp;is when the truth is assumed based on a lack of wealth whereas the <i>appeal to wealth</i>&nbsp;is when the truth is assumed based on an excess of wealth.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;While my financial status might impress the participants at an Amway conference, it has little to do with my knowledge of fallacies.&nbsp;&nbsp;However, remember the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Argument-from-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Concluding that the truth value of an argument is false based on the fact that the argument contains a fallacy.">argument from fallacy</a></i>; just because the argument is fallacious, does not mean the conclusion is not true, dammit.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p>
      <strong>Tip:</strong>&nbsp;There is nothing wrong with a little self-promotion.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Without knowing who these scientists are, or the credibility of the source of the article, we cannot verify the evidence; therefore, we should not accept the evidence.
    </p>
    <p class="Body">
      <strong>Exception: </strong>At times, an accepted fact uses the same indicating phrases like the ones used for the fallacy; therefore, if the anonymous authority is actually just a statement of an accepted fact, it should be accepted as evidence.
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Accepting a claim of a celebrity based on his or her celebrity status, not on the strength of the argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Tom Cruise&nbsp;might be awesome, and perhaps he really does think Billy Boy Butter is the best tasting butter there is, but Tom is no more an authority on the taste of butter than anyone else; therefore, to accept the claim without any other evidence or reason is fallacious.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <!--
        ...
        p { margin-top: 0 }
      -->
    <strong type="text/css">Description:</strong>&nbsp;Using an alleged authority as evidence in your argument when the authority is not really an authority on the facts relevant to the argument. As the audience, allowing an irrelevant authority to add credibility to the claim being made. Also see the <em><i><a href="https://www.logicallyfallacious.com/logicalfallacies/Appeal-to-Authority" target="fallacy" data-toggle="tooltip" title="" data-original-title="Insisting that a claim is true simply because a valid authority or expert on the issue said it was true, without any other supporting evidence offered. Also see the appeal to false authority.">appeal to authority</a></i></em>.

    <p class="Body">
      <strong>Logical Forms:</strong>
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      According to person 1 (who offers little or no expertise on Y being true), Y is true.<br/>Therefore, Y is true.
    </p>
    <br/>
    

    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      According to person 1 (who offers little or no expertise on Y being true), Y is true.<br/>Therefore, Y is more likely to be true.
    </p>
    <br/>
...
<header/>    
    ...
    <p class="Body">
      <strong>Description:</strong>&nbsp;When a person making a claim is presented as an expert who should be trusted when his or her expertise is not in the area being discussed.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Assuming Dr. Dean is actually a licensed psychologist, that does not qualify him to give advice about non-psychology related issues such as coffee enemas. Extending his expertise from psychology to issues of the colon is fallacious.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Become an expert in something.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Armondo may be right, but the dictionary is not the final authority on all issues, especially social behavior.&nbsp;&nbsp;More modern usage, especially in a high school setting, takes precedence in this case.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;The dictionary works well when the term in question is a result of a misunderstanding or ignorance.&nbsp;&nbsp;For example:
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Wilson, K. G. (1993). <i>The Columbia Guide to Standard American English</i>. Columbia University Press
        </div>
      </div>
    </div>
  </body>
...
<node TEXT="Non-anticipation" ID="ID_1376719465" CREATED="1642352335820" MODIFIED="1642352339098"/>
</node>
</node>
...
<html>
  ...
  <body>
    ...
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      X is natural.<br/>Y is not natural.<br/>Therefore, X is better than Y.<br/><br/>
    </p>
    <p class="uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
    ...
    <p class="uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      Therefore, X is good, right, beautiful, etc.<br/><br/>
    </p>
    <p class="uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Asserting that given any two positions, there exists a compromise between them that must be correct.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This is a refusal to accept a well-proven argument for one of many reasons related to stubbornness. It can also be the refusal to argue about a claim that one supports.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Blake is offering no counter argument or reasoning for rejecting his dad's well-articulated argument. He is simply being stubborn.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      Jorge: Do you hate that she launched the national campaign, &quot;Let's Move!,&quot; to reduce childhood obesity?<br/>Cathy: Yes.<br/>Jorge: Do you hate that she launched the national veterans' campaign, &quot;Joining Forces,&quot; with Dr. Jill Biden?<br/>Cathy: Yes.<br/>Jorge: Do you hate that she traveled to Africa for a week to focus on youth leadership, education, health, and wellness?<br/>Cathy: Yes.<br/>Jorge: Do you hate that she launched the national campaign, &quot;Reach Higher,&quot; a higher education initiative?<br/>Cathy: Yes.<br/>Jorge: Do you hate that she launched the national campaign, &quot;Let Girls Learn,&quot; a global focus on girls' education?<br/>Cathy: Yes.
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;As a reminder, avoid absolutes. Instead of saying that you &quot;hate everything&quot; about someone, say something such as, &quot;there's not much I like about...&quot;
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Offering false or inauthentic excuses for our claim because we know the real reasons are much less persuasive or more embarrassing to share, or harsher than the manufactured ones given.
...
<header/>    
    ...
    <div class="content clearfix">
      ...
      <p class="Body">
        <strong>Description:</strong>&nbsp;Attempting to redirect the argument to another issue to which the person doing the redirecting can better respond. While it is similar to the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Avoiding-the-Issue" target="fallacy" data-toggle="tooltip" title="" data-original-title="When an arguer responds to an argument by not addressing the points of the argument.  Unlike the strawman fallacy, avoiding the issue does not create an unrelated argument to divert attention, it simply avoids the argument.">avoiding the issue</a></i>&nbsp;fallacy, the <i>red herring </i>is a deliberate diversion of attention with the intention of trying to abandon the original argument.
      </p>
      <p class="Body">
        <strong>Logical Form:</strong>
      </p>
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Ken has successfully derailed this conversation off of his sexual digressions to the deep, existential, discussion on morality.
      </p>
      <p class="Body">
        <strong>Example #2:</strong>
      </p>
      <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
        Billy: How could the universe be 6000 years old when we know the speed of light, the distance of astronomical objects (13+ billion light years away), and the fact that the light has reached us<a title="" href="http://www.logicallyfallacious.com/index.php/logical-fallacies/151-red-herring#_ftn1"><sup>[1]</sup></a>?
      </p>
      <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Marty has succeeded in avoiding the devastating question by introducing a new topic for debate... shifting the young-earth creation timeline where it does not necessarily coincide with the Bible.
      </p>
      <p class="Body">
        <strong>Exception:</strong>&nbsp;Using a <i>red herring</i>&nbsp;to divert attention away from your opponent's <i>red herring</i>, might work, but do two wrongs make a right?
      </p>
      <p class="Body">
...
<html>
  ...
  <body>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>A lot of people believe X.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Therefore, X must be true.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The <i>geocentric model</i>&nbsp;was an observation (limited) and faith-based, but most who accepted the model did so based on the common and accepted belief of the time, not on their own observations, calculations, and/or reasoning.&nbsp;&nbsp;It was people like Copernicus, Galileo, and Kepler, who refused to <em>appeal to the common belief</em>&nbsp;and uncovered a truth not obvious to the rest of humanity.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;History has shown that those who break away from the common beliefs are the ones who change the course of history.&nbsp;&nbsp;Be a leader, not a follower.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The charm of the arguer is irrelevant to the issue of abortion.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Asserting a conclusion without evidence or premises, through a statement that makes the conclusion appear certain when, in fact, it is not.
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;There is no valid reason given for the increase in taxes.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Mormonism is indeed rapidly growing, but that fact does not prove the truth claims made by Mormonism in any way.
    </p>
    <p class="Body">
      <strong>Example #2: </strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;When the claim being made is about the popularity or some related attribute that is a direct result of its popularity.
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      People seem to love the movie, <i>The Shawshank Redemption</i>.&nbsp;&nbsp;In fact, it is currently ranked #1 at IMDB.com, based on viewer ratings.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Avoid this fallacy like you avoid a kiss from your great aunt with the big cold sore on her lip.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When someone presents an atypical or weak member of a group as if they are a typical or strong representative.
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;I have heard a couple of people refer to the <em>cherry picking fallacy</em>&nbsp;as the <em>nutpicking fallacy</em>. Review the <em>cherry picking fallacy</em>&nbsp;and you will see that there are notable differences.
    </p>
  </body>
</html>
...
<html>
  ...
  <body>
    ...
    <p>
      <strong>Exception:</strong>&nbsp;This is a fallacy contingent upon evidence. If enough evidence exists that the majority of the group outliers in question are imposters, then there is no fallacy.
    </p>
    <p>
      <strong>Fun Fact:</strong>&nbsp;The imposter fallacy is often committed with the deceptive sharing fallacy when one shares a one-off story about an actual imposter.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description: </strong>Using the technical tools of logic in an unhelpful and pedantic manner by focusing on trivial details instead of directly addressing the main issue in dispute.&nbsp;&nbsp;Irrelevant over precision.

    <p class="Body">
      <i>Pay close attention to this fallacy, because after reading this book, you may find yourself committing this fallacy more than any others, and certainly more often than you did before reading this book.</i>
    </p>
    <p class="Body">
      <strong>Logical Form:</strong><i><br/></i>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><i>A claim is made.<br/>An objection is made regarding a trivial part of the claim, distracting from the main point.</i></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;You can see here that Paul is avoiding the request for assistance by attempting to make a deep philosophical issue out of a simple request.&nbsp;&nbsp;While Paul may have some good points, not every situation in life calls for deep critical thought.&nbsp;&nbsp;This situation being one of them.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This kind of fallacy could easily be a result of someone with paranoid behavioral tendencies -- thinking the world is out to get him or her.
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Byerly, H. C. (1973). <i>A primer of logic</i>. Harper &amp; Row.
        </div>
      </div>
    </div>
  </body>
...
<node TEXT="Irrelevant Humour" ID="ID_1891602429" CREATED="1642352207713" MODIFIED="1642352212378"/>
</node>
...
<html>
  ...
  <body>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Therefore, claim Y is false.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Ted: Biological evolution is both a theory and a fact.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Edwin: That is ridiculous!&nbsp;&nbsp;How can you possibly be absolutely certain that we evolved from pond scum!</em></font>
    </p>
    <p style="padding-left: 40px">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_22427007" STARTINCLINATION="2274;0;" ENDINCLINATION="2274;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="NOTE">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Applying standards, principles, and/or rules to other people or circumstances, while making oneself or certain circumstances exempt from the same critical criteria, without providing adequate justification.&nbsp;&nbsp;Special pleading is often a result of strong emotional beliefs that interfere with reason.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>If X then Y, but not when it hurts my position.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Walton, D. (1999). <i>One-Sided Arguments: A Dialectical Analysis of Bias</i>. SUNY Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Claiming something is true for one person, but not for someone else when, in fact, it is true for everyone (objective) as demonstrated by empirical evidence.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Sorry Terry, smoking is unhealthy for everyone -- you are no different.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Besides being a case of the <i>subjectivist fallacy</i>, Ted is also moving outside the realm of reason and logic.
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Peacocke, C. (2005). <i>The Realm of Reason</i>. Clarendon Press.
        </div>
      </div>
    </div>
  </body>
...
<node TEXT="Well, then you can ask them to send you the answers by e-mail anyway, they will see" ID="ID_1393895741" CREATED="1642763793117" MODIFIED="1642763793117"/>
</node>
</node>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;It's all about good communication. Keep your assumptions to a minimum when attempting to make a persuasive argument.
    </p>
    <header/>
...
<header/>    
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The unwillingness to entertain ideas that one finds unbelievable is fallacious, especially when the ideas are mainstream ideas made by a reputable source, such as a NASA and the truthfulness of the moon landings.
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;Drawing a conclusion based on the silence of the opponent, when the opponent is refusing to give evidence for any reason.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The reason this technique works so well, is because <i>imagined reasons are often more persuasive than real reasons</i>.&nbsp;&nbsp;If someone wants to be convinced, this technique works like a charm.&nbsp;&nbsp;However, to the critical thinker, this will not fly.&nbsp;&nbsp;Silence is not a valid substitute for reason or evidence.
    </p>
    <p>
      <strong>Exception:</strong>&nbsp;Generally speaking, absence of evidence is not evidence; however, there are many cases where the <i>reason</i>&nbsp;evidence is being held back can be seen as evidence.&nbsp;&nbsp;In the first example, prompting Silent Bob to share a reason for his silence could result in a statement from Silent Bob that can be used as evidence.
    </p>
    <p>
      <strong>Tip:</strong>&nbsp;Silence can be very powerful. In public speaking, knowing when to pause and let the audience digest what you said helps them comprehend your message. In argumentation, a pause after making a solid point can increase the odds your interlocutor(s) will accept the point.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Offering a bizarre (far-fetched) hypothesis as the correct explanation without first ruling out more mundane explanations.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Far-fetched hypothesis is proposed.</em></font><br/><font color="rgb(52, 73, 94)"><em>Mundane, probable hypotheses are ignored.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>The rainbow represents a special covenant or promise of protection from another worldwide flood. The rainbow's appearance to Noah may have been its first occurrence in the sky (Gen. 9:8-17). Typical raindrops of sufficient size to cause a rainbow require atmosphere instability. Prior to the Flood, weather conditions were probably very stable. (Donald B. DeYoung, Weather and The Bible, Grand Rapids, Eerdmans, 1992, pp. 112,113).</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is part of an attempt by a young-earth creationist to make Genesis a literal, historical fact.&nbsp;&nbsp;Of course, the mundane explanation is that Genesis is not meant to be taken as a literal, historical fact -- it is not meant to be read as a science book.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;If mundane explanations can be ruled out first, usually through falsification, then we can move on to more bizarre hypotheses.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;The <em>Principle of Parsimony</em>&nbsp;states that the most acceptable explanation of an occurrence, phenomenon, or event is the simplest, involving the fewest entities, assumptions, or changes.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Dennett, D. C. (2006). <i>Breaking the Spell: Religion as a Natural Phenomenon</i>. Penguin.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Making the claim that something is &quot;self-evident&quot; when it is not self-evident in place of arguing a claim with reason. In everyday terms, something is &quot;self-evident&quot; when understanding what it means immediately results in knowing that it is true, such as 2+2=4. The concept of self-evidence is contentions and argued among philosophers based on their ideas of epistemology. This means that what is &quot;self-evident&quot; to one person is not necessarily self-evident to another. However, some ideas are clearly self-evident and some are not.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Person 1 claims Y without evidence.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 2 asks for evidence.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 claims that Y is self-evident.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Richie: Lord Xylon is the one true ruler of the universe.</em></font><br/><font color="rgb(52, 73, 94)"><em>Toby: Why do you think that?</em></font><br/><font color="rgb(52, 73, 94)"><em>Richie: It is self-evident.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;People often confuse their own subjective feelings and interpretations with self-evidence. Richie may believe that Lord Xylon is the one true ruler of the universe, but his belief cannot be used in place of evidence.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Sara: No human should ever kill another human being.</em></font><br/><font color="rgb(52, 73, 94)"><em>Dottie: Why not?</em></font><br/><font color="rgb(52, 73, 94)"><em>Sara: It's self-evident.</em></font>
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If you can't explain something, that doesn't mean you are dealing with something that is self-evident; it could just be your failure to explain something.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This is an abandonment of reason in an argument and a call to faith, usually when reason clearly leads to disproving the conclusion of an argument.&nbsp;&nbsp;It is the assertion that one must have (the right kind of) faith in order to understand the argument.&nbsp;
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;An assertion is deemed true or false based on an assumed pretense of equality, where what exactly is &quot;equal&quot; is not made clear, and not supported by the argument.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>A equals B (when A does not equal B)</em></font><br/><font color="rgb(52, 73, 94)"><em>Y applies to A or B.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, Y applies to both A and B.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Gay marriage should be the law of the land because gays should have the same rights as heterosexuals.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;What do the &quot;same rights&quot; mean? Before gay marriage, men had the right to marry women, and women had the right to marry men. A man marrying a man is a different form of the &quot;right of marriage&quot; and needs to be argued as such. Again, there are many excellent arguments for gay marriage, but this isn't one of them.
    </p>
    <p class="Body">
      <strong>Example #3:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Why should fetuses not have human rights, yet when they exit the womb as babies, they do have human rights? Clearly, fetuses deserve to have the same human rights as the rest of us.</em></font>
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    ...
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      I believe X is true.<br/>Believing in X results in practical benefit Y.<br/>Therefore, X is true.
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      <a href="http://skepdic.com/pragmatic.html">http://skepdic.com/pragmatic.html</a>
    </div>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description: </strong>Refusing to admit ignorance to the hypothesis and/or the conclusion, but insisting that your ignorance has to do with missing data that validate both the hypothesis and conclusion.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">Hypothesis H is put forward.</font></em>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">Fatal Flaw F is pointed out.</font></em>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">Rather than change the hypothesis to match the data, it is simply assumed that there must be data missing that will eliminate flaw F.</font></em>
    </p>
    <p class="Body">
      <strong>Example #1: </strong>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">Jeremy: Drinking Diet Cosie Cola will result in the reversal of male-pattern baldness.</font></em>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">Rick: This has never been established scientifically.</font></em>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">Jeremy: That is because it must be mixed with another ingredient.</font></em>
    </p>
    <p style="padding-left: 40px">
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Gil: Scientists have no idea what the appendix is for because they refuse to accept that its function is the source of psychic powers in humans that we have forgotten how to use.</em></font>
    </p>
    <p style="padding-left: 40px">
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Gil: You know, John, there is plenty of evidence against the authenticity of this.</em></font>
    </p>
    <p style="padding-left: 40px">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Accepting good effort as a valid reason to accept the truth of the conclusion, even though the effort is unrelated to the truth.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The fact that William made a <i>notable effort</i>&nbsp;&nbsp;to prove his claim does not mean that he did.
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Yes, the evolution of the eye is confusing to non-biologists and those who are not familiar with evolutionary theory and natural selection. But the complexity of this argument is not a reason to reject it or find it less credible than a simpler claim (e.g. Zeus created eyes from clay).
    </p>
    <p class="Body">
      <strong>Example #2:</strong>&nbsp;If a layperson criticizes a complex policy about which they know nothing or very little, they are probably <i>appealing to complexity</i>.
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Black and white thinking is found where one has a lack of knowledge about a topic. Policies such as national healthcare are incredibly complex where each change has benefits and drawbacks. Non-experts often will dismiss a 1000-page document and say something such as, &quot;Look, it's simple. Do this, this, and this. Problem solved.&quot; No, it's not simple, and that wouldn't solve the problem.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;When the one making the argument doesn't understand what they are actually saying, they are committing the <a href="https://www.logicallyfallacious.com/tools/lp/Bo/LogicalFallacies/47/Argument-by-Gibberish"><i>argument by gibberish</i></a>.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;It is the job of the arguer to make the argument as clear as possible, and use language and terms that the audience can understand. This is a major problem in science communication. The <i>curse of knowledge</i>&nbsp;often leads to those trying to explain a complex topic in such a way where they assume the audience has as much knowledge in the fields as they do. If your audience fails to understand your argument, don't blame the audience;&nbsp;&nbsp;explain your argument differently.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <div class="content clearfix">
      <p style="font-style: italic">
        <strong>Description:</strong>&nbsp;Confidently asserting that a theory or hypothesis is true or false even though the theory or hypothesis cannot possibly be contradicted by an observation or the outcome of any physical experiment, usually without strong evidence or good reasons.
      </p>
      <p class="Body">
      ...
      <p class="Body" style="padding-left: 40px">
        <font color="rgb(52, 73, 94)"><em>X is true (when X is cannot possibly be demonstrated to be false)</em></font>
      </p>
      <p class="Body">
        <strong>Example #1:</strong>
      </p>
      ...
      <div class="small" style="padding-left: 22px; text-indent: -22px">
        Flanagan, O. J. (1991). <i>The Science of the Mind</i>. MIT Press.
      </div>
    </div>
  </body>
</html>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_480276856" STARTINCLINATION="1017;0;" ENDINCLINATION="1017;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Concluding that the truth value of an argument is false based on the fact that the argument contains a fallacy.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Unfairly blaming an unpopular person or group of people for a problem or a person or group that is an easy target for such blame.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This was an actual argument seen in the months that followed hurricane Katrina.&nbsp;&nbsp;Ignoring the validity of the claims being made, the arguer is blaming a natural disaster on a group of people.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;There is no exception when people are being unfairly blamed.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;<em>Scapegoating</em>&nbsp;meets a deep psychological need for justice, or more accurately, the <em>belief</em>&nbsp;that justice has been served.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Douglas, T. (2002). <i>Scapegoats: Transferring Blame</i>. Routledge.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When the emotions of anger, hatred, or rage are substituted for evidence in an argument.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Using social norms to determine what is good or bad.&nbsp;&nbsp;It is the idea that normality is the standard of goodness.&nbsp;&nbsp;This is fallacious because social norms are not the same as norms found in nature or norms that are synonymous with the ideal function of a created system.&nbsp;&nbsp;The conclusion, &quot;therefore, it is good&quot; is often unspoken, but clearly implied.

    <p class="Body">
      <strong>Logical Forms:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is considered normal behavior.<br/>Therefore, X is good behavior.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is not considered normal behavior.<br/>Therefore, X is bad behavior.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is considered normal behavior.<br/>Therefore, we should strive for X (normality).</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <em><font color="rgb(52, 73, 94)">I am only slightly obese.&nbsp;&nbsp;That is perfectly normal here in America.</font></em>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;&nbsp;The person is correct in that being slightly obese is considered normal in America.&nbsp;&nbsp;In no way is this a good thing by virtually any measure of goodness.&nbsp;&nbsp;Athletes and those who make their health and fitness a priority are far from normal, but viewing that level of health and fitness as bad is clearly fallacious.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;For the most part, being &quot;normal&quot; or &quot;average&quot; is nothing to be proud of.&nbsp;&nbsp;Be better than average.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Judging a person's decision in the light of new information not available at the time.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Arp, R. (2013). <i>1001 Ideas That Changed the Way We Think</i>. Simon and Schuster.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Confusing subjective experiences, usually very emotionally charged, with objective reality, then suggesting or demanding that others accept the subjective experience as objective reality.

    <p class="Body">
      <strong>New Terminology:</strong>&nbsp;In this context, <em>subjective experience</em>&nbsp;&nbsp;is the way one interprets some external stimuli. <em>Objective reality</em>&nbsp;&nbsp;is independent of our interpretations; it is a collection of facts about the world we all share.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Person 1 has subjective experience X.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 incorrectly believes that experience X represents objective reality.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, person 1 insists that others accept that X represents objective reality.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>I feel that we are all surrounded by Narggles. These are spiritual beings who help us through life. We know they exist because they are the ones that give us the confidence to move forward in a decision.</em></font>
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;Everyone knows Kerplunkers, not Narggles, are spiritual beings who help us through life.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The deliberate and excessive use of acronyms and abbreviations to appear more knowledgeable in the subject or confuse others.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Simply overusing acronyms is not the problem here; it's the deliberate overuse for the purpose of making people think the speaker is very knowledgeable in this area, or perhaps to use terms the audience is unaware of, making the audience think they need the consulting service more than they thought they did.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Don't be so quick to assume nefarious intentions. Sometimes people simply are unaware that they are overusing this type of language.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The argument is created so that any woman accused of being a witch will die, which is certainly a lose-lose situation.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Switching the antecedent and the consequent in a logical argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;There are many who could, rightly so, disagree with the first premise, but assuming that premise is true, does not guarantee that the conclusion is true.&nbsp;&nbsp;There are many smart people without PhDs.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I am glad this is not true.&nbsp;&nbsp;One can have non-herpes rashes.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;If p=q, then it is necessarily true that q=p.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If you think might herpes, see your doctor.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Pickard, W. A., &amp; Aristotle. (2006). <i>On Sophistical Refutations</i>. ReadHowYouWant.com, Limited.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="uk-margin-remove uk-text-primary" style="display: block; font-style: italic; padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Person 1 wants claim X be justified.<br/>Person 2 explains claim X in detail.<br/>Therefore, claim X is justified / true.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <div>
      <strong>Example #2:<br/><br/></strong>
    </div>
    <div style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Virgil: How do you justify the claim that Bigfoot is the missing link between the great apes and humans?<br/>Marshall: Well, a &quot;missing link&quot; is the intermediary species between the two in the evolutionary process.<br/><br/></em></font>
    </div>
    <p>
      <strong>Explanation:</strong>&nbsp;Marshall simply explained what a missing link is; he did not give a valid reason for why he believes that Bigfoot is the missing link.
    </p>
    <p>
...
<html>
  ...
  <body>
    ...
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      While we may be able to explain <strong>how</strong>&nbsp;humans got here, we <strong>may</strong>&nbsp;&nbsp;never be able to explain <strong>why</strong>&nbsp;(assuming there is a why).
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Be careful using terms such as &quot;impossible&quot; and &quot;possible.&quot; The casual use of both terms is often incorrect within argumentation.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Explaining that your claim cannot be proven or verified because the truth is being hidden and/or evidence destroyed by a group of two or more people.&nbsp;&nbsp;When that reason is challenged as not being true or accurate, the challenge is often presented as just another attempt to cover up the truth and presented as further evidence that the original claim is true.
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Take time to question any conspiracy theories in which you believe are true.&nbsp;&nbsp;Do the research with an open mind.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Barkun, M. (2006). <i>A Culture of Conspiracy: Apocalyptic Visions in Contemporary America</i>. University of California Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Attempting to support a narrative or argument with facts that don't support the narrative or argument. The distinguishing characteristic of the fact-to-fiction fallacy is <strong>the accusation that those who reject your conclusion are rejecting the facts.</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Claiming that the cause is true or false based on what we know about the effect in a claim of causality that has not been properly established. The cause is often an implied claim, and it is this claim that is being deemed true or false, right or wrong.
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;This fallacy is different from the <em>false cause</em>&nbsp;&nbsp;fallacy (listed under <em>questionable cause</em>).
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The assumption that because an individual is not in formation with the group, that the individual must be the one off course. It is possible that the one who appears off course is the only one on the right course.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The assumption here is that the &quot;other girls&quot; are doing the right thing. This needs to be established or demonstrated through reason and evidence.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;It is just as wrong to assume that the one is &quot;out of formation&quot; as it is to assume that all the rest must be &quot;out of formation.&quot; While it might be statistically more probable that the one is out of formation, evidence should be sought before making any definitive claim.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Compare this to the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Galileo-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="The claim that because an idea is forbidden, prosecuted, detested, or otherwise mocked, it must be true, or should be given more credibility. This originates from Galileo Galilei's famous persecution by the Roman Catholic Church for his defense of heliocentrism when the commonly accepted belief at the time was an earth-centered universe.">Galileo fallacy</a></i>&nbsp;. You will see that being the oddball neither makes you right nor wrong.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Laing, R. D. (1990). <i>The Politics of Experience and The Bird of Paradise</i>. Penguin Books Limited.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Refining your claim simply to avoid counter evidence and then acting as if your revised claim is the same as the original.
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;Every time you acknowledge that you are wrong, you are one step closer to actually being right.
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;In terms of a fallacious argument, two or more propositions are asserted that cannot both possibly be true.&nbsp;&nbsp;In a more general sense, holding two or more views/beliefs that cannot all be true together.&nbsp;&nbsp;Quotes from Yogi Berra (even if apocryphal) are great examples of fallacies, especially inconsistencies.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Proposition 1 is logically inconsistent with proposition 2.</em></font><br/><font color="rgb(52, 73, 94)"><em>Proposition 1 and proposition 2 are both asserted or implied to be true.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1: </strong>
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      &quot;I never said most of the things I said.&quot; - <i>Yogi Berra</i>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I know this requires no explanation, and I don't mean to insult your intelligence, but for consistency's sake, I will explain.&nbsp;&nbsp;If he had said those things, then he said them, which is a contradiction to his claim that he never said them. This is both an <i>internal inconsistency</i>&nbsp;and a <i>logical inconsistency</i>. It is internal because the inconsistency is contained within the statement itself; it doesn't require any other premises or arguments.
    </p>
    <p class="Body">
      <strong>Example #2: </strong>
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      &quot;Nobody goes there anymore.&nbsp;&nbsp;It's too crowded.&quot; - <i>Yogi Berra</i>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Again, I apologize, but here it goes... If &quot;nobody&quot; went there, then it could not possibly be crowded, since &quot;crowded&quot; implies too many people are there. This is both an <i>internal inconsistency</i>&nbsp;and a <i>logical inconsistency</i>.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;One needs to be able to explain how the beliefs are not inconsistent.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Think about your beliefs.&nbsp;&nbsp;Are there any inconsistent with each other?&nbsp;&nbsp;Any inconsistent with how you act and what you do?
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Reasoning that because authorities cannot agree precisely on an issue, no conclusions can be reached at all, and minimizing the credibility of the authorities, as a result.&nbsp;&nbsp;This is a form of black and white thinking -- either we know the exact truth, or we know nothing at all.&nbsp;
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;A disagreement among experts does not mean that both are wrong, the answer is a compromise, or that there is no answer to be known; it simply means that there is disagreement -- that is all we can infer.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;When experts have very different views on scientific issues, it is very often the case that one or more of them are sharing views outside their realm of professional expertise.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Wormeli, R. (2001). <i>Meet Me in the Middle: Becoming an Accomplished Middle-level Teacher</i>. Stenhouse Publishers.
        </div>
      </div>
      <p class="Body">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Failing to appeal to an underlying cause, and instead simply appealing to membership in a category.&nbsp;&nbsp;In other words, simply asserting what you are trying to explain without actually explaining anything.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Claim X is made about Y.</em></font><br/><font color="rgb(52, 73, 94)"><em>Claim X is true because Y is a member of category Z.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>I need oxygen because I am human!</em></font>
    </p>
    <p>
      <strong>Fun Fact:</strong>&nbsp;Mormons getting their own planet in the Mormon afterlife is actually a misconception, not official Mormon doctrine.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Farha, B. (2013). <i>Pseudoscience and Deception: The Smoke and Mirrors of Paranormal Claims</i>. University Press of America.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The theory doesn't explain anything other than the phenomenon it explains (that one thing), and at best, is likely to be incomplete.&nbsp;&nbsp;This is often done by just redefining a term or phrase rather than explaining it.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Theory X is proposed to explain Y.</em></font><br/><font color="rgb(52, 73, 94)"><em>Theory X explains nothing else but Y.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <p>
      <em>Fun Fact:</em>&nbsp;In a group of 23 random people, it is more likely than not that at least two of the people in the group have the same birthday. This is referred to a the <em>birthday paradox</em>&nbsp;and it is a classic example of the <em>multiple comparisons fallacy</em>.
    </p>
    <p class="Body">
      <strong>References:</strong>
    </p>
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Walsh, J. (1996). <i>True Odds: How Risk Affects Your Everyday Life</i>. Silver Lake Publishing.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This is a form of poor statistical thinking where one or more statistically rare cases are implied to be the norm or the trend (without evidence) for the purpose of expressing or inciting outrage toward an entire group. It is a form of extreme <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Stereotyping-the-fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="The general beliefs that we use to categorize people, objects, and events while assuming those beliefs are accurate generalizations of the whole group.">stereotyping (the fallacy)</a></i>, based on the cognitive bias known as the <i>group attribution error</i>.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Violent crime by illegal immigrants is rarer than violent crime committed by U.S. citizens [1]. However, if the narrative a media outlet is trying to sell is that illegal immigrants are dangerous, then they can influence public opinion by inferring that one example of such violence is characteristic of the group. Expressing outrage is a way to make the influence even more effective.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;People and the media (biased media) tend to associate a physical or social identity to the perpetrator of a crime for the purpose of damaging the group's public perception. Why a &quot;Republican&quot; man? How many Republicans are assaulting Muslim women? How many Democrats are? The data are ignored for the benefit of the narrative being sold.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;There is no exception. If it is &quot;overextended,&quot; then the problem is being exaggerated, and a group of people is unfairly demonized.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Next time you read about a story that makes you feel outraged, direct your outrage to the individuals directly involved in the story. Don't demonize an entire physical or social identity.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Drawing a conclusion from correlations observed in a given sample, but only after the sample has already been drawn, and without declaring in advance what correlations the experimenter was expecting to find.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>A sample from a data set is drawn.</em></font><br/><font color="rgb(52, 73, 94)"><em>A correlation is found that was not looked at nor is it statistically surprising.</em></font><br/><font color="rgb(52, 73, 94)"><em>The correlation is seen as being meaningful.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>In looking at the difference between 100 Christians and 100 atheists, we found that Christians were significantly more likely to eat tuna fish.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;When you fish for data, you are bound to catch something -- in this case, tuna.&nbsp;&nbsp;Notice that because we were looking for anything, we are bound to find it.
    </p>
    <p>
...
<html>
  ...
  <body>
    <strong>Description: </strong>Making an argument purposely difficult to understand in an attempt to intimidate your audience into accepting it, or accepting an argument without evidence or being intimidated to question the authority or <i>a priori</i>&nbsp;assumptions of the one making the argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Despite the intellectually intimidating presence of Dr. Professor Pete, 1+1 still equals 2.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;If you live in a state where you can be killed for asking questions, then this is not a fallacy, but a survival technique.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If you live in a state where you can be killed for asking questions, move.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Terrell, D. B. (1967). <i>Logic: A Modern Introduction to Deductive Reasoning</i>. Holt, Rinehart and Winston.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A claim masquerading as proof or evidence, when no such proof or evidence is actually being offered.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The arguer states that the author is &quot;simply wrong&quot; yet offers no reasons. Words and phrases such as &quot;simply,&quot; &quot;obviously,&quot; &quot;without question,&quot; etc., are indicators that no such evidence will be presented.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Claims that are universally accepted as self-evident truths don't apply.
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      If you put your penis in a wood chipper, it's going to hurt.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If you have a penis, don't put it in a wood chipper.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Dowden. (1993). <i>Logical Reasoning Im</i>. Thomson Learning EMEA, Limited.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Demanding that one proves the non-existence of something in place of providing adequate evidence for the existence of that something.&nbsp;&nbsp;Although it may be possible to prove non-existence in special situations, such as showing that a container does not contain certain items, one cannot prove universal or absolute non-existence.
    ...
    <p class="Body">
      ...or anything else which is just as likely to come from your imagination that is untestable and <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Unfalsifiability" target="fallacy" data-toggle="tooltip" title="" data-original-title="Confidently asserting that a theory or hypothesis is true or false even though the theory or hypothesis cannot possibly be contradicted by an observation or the outcome of any physical experiment, usually without strong evidence or good reasons.">unfalsifiable</a></i>&nbsp;, then you might want to reconsider the fact that your being of choice is really paying you visits.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;Inferring some psychological reason why an argument is made then assuming it is invalid, as a result.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Besides the fact that &quot;smokin' hot&quot; is a subjective evaluation, meaning that the girls could be hot to George but not Derek, Derek is assuming George's evaluation is wrong because of the psychological effect known as the <i><a href="https://en.wikipedia.org/wiki/Cheerleader_effect">cheerleader effect</a></i>.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;There are two problems here that make Katie guilty of fallacious reasoning. First, she is assuming Lucas' story is not true because of a false memory. Second, she is phrasing this objection with unwarranted confidence.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;The more extraordinary the argument or claim, the more reasonable it is to assume a psychological effect is involved. However, even in the most extraordinary of claims, the effect should only be proposed, not assumed.
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
...
<html>
  ...
  <body>
    <div class="content clearfix">
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Sam knows nothing about quantum physics, so really cannot respond, yet Depook did not establish an argument as to how it provides evidence, he just made the assertion.&nbsp;
      </p>
      <p class="Body">
        <strong>Example #2:</strong>
      </p>
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Sam knows nothing about quantum physics, so really cannot respond.&nbsp;&nbsp;Depook did expand on his assertion here, relied on the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Argument-by-Gibberish" target="fallacy" data-toggle="tooltip" title="" data-original-title="When incomprehensible jargon or plain incoherent gibberish is used to give the appearance of a strong argument, in place of evidence or valid reasons to accept the argument.">argument by gibberish</a></i>&nbsp;in order to make what sounded like scientific claims which, in fact, were not.&nbsp;&nbsp;According to everything we know about quantum physics, information cannot travel faster than light -- otherwise, it could create a <i>time travel paradox</i>.
      </p>
      <p class="Body">
        <strong>Exception:</strong>&nbsp;Making a scientific claim about quantum physics, using the scientific method, is not fallacious.
      </p>
      <p class="Body">
        <strong>Tip:</strong>&nbsp;Pick up an introductory book on quantum physics, it is not only a fascinating subject, but you will be well prepared to ask the right questions and expose this fallacy when used.
      </p>
    </div>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Invoking the cause to eliminate the effect, or calling on the source to relieve the effect of the source.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X causes/is the source of Y.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>In order to eliminate or relieve Y, do more of X.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Jen: Then what are you doing about it?</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Bridget: Drinking to forget.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Bridget has a drinking problem that she is dealing with by drinking some more -- because the effects of drinking make her (temporarily) forget/not worry about the greater scale effects of her drinking.&nbsp;&nbsp;Her reasoning that this is a good idea is fallacious.
    </p>
    <p>
      <strong>Example #2:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)">David: We have way too much police presence in this city.</font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)">Pete: What are you going to do about it?</font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)">David: Vandalize, loot, and perhaps a little arson.</font>
    </p>
    <div class="content clearfix">
      <strong>Explanation:</strong>&nbsp;The primary role of the police is to enforce laws. David is suggesting that breaking the laws will facilitate his goal of having the police force reduced.
    </div>
    <div class="content clearfix">
      <br/>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Assuming that just because a person's intentions are good, they have the truth or facts on their side. Also see <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Self-Righteousness-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Assuming that just because your intentions are good, you have the truth or facts on your side. Also see righteousness fallacy.">self-righteousness fallacy</a></i>.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Jenni's grandmother might be the queen of honor with kindness oozing from her orthopedic shoes, but these qualities are independent of one's ability to know facts or come to an accurate conclusion based on available data.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The good intentions of the president are separate from the president's ability to get solid intelligence on foreign affairs. If we are convinced of the president's good intentions, the best we can do is claim that we believe that the president believes he is doing the right thing.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;This relates to facts, not subjective truth. We can use the idea of righteousness to conclude how we feel about a person.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;This is related to the cognitive bias, the <em>halo effect</em>.
    </p>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Assuming that just because your intentions are good, you have the truth or facts on your side. Also see <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Righteousness-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Assuming that just because a person's intentions are good, they have the truth or facts on their side. Also see self-righteousness fallacy.">righteousness fallacy</a></i>.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>You make claim X.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>You have good intentions.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Therefore, X is true.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
...
<html>
  ...
  <body>
    ...
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Information is presented.</em></font><br/><font color="rgb(52, 73, 94)"><em>Response addresses only some of the information, completely ignoring the rest.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Ignoring irrelevant information is a good thing when evaluating arguments.&nbsp;&nbsp;The key is to know what is irrelevant.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;<em>Selective attention</em>&nbsp;is mostly a cognitive bias in that it happens subconsciously. It becomes a fallacy when it shows up in argumentation.
    </p>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description: </strong>An argument or position is self-sealing if and only if no evidence can be brought against it no matter what.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Claim X is made.</em></font><br/><font color="rgb(52, 73, 94)"><em>Reason Y is given for claim X.</em></font><br/><font color="rgb(52, 73, 94)"><em>Reason Y can not possibly be refuted.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Tina: My life is guided by destiny.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Mary: How do you know that?</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Tina: Whatever comes my way is what was meant to be.</em></font>
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Holding beliefs that are unfalsifiable is not fallacious, especially when stated as beliefs or opinions. This becomes fallacious when an unfalsifiable claim is presented as evidence in argumentation.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Realize that most superstitious beliefs are centered around self-sealing or vacuous arguments, that is why so many people refuse to let go of superstitious beliefs -- because they cannot be proven false.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Blair, J. A. (2011). <i>Groundwork in the Theory of Argumentation: Selected Papers of J. Anthony Blair</i>. Springer Science &amp; Business Media.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Jack made a claim that requires justification. Nick asked for the evidence, but Jack shifted the burden of proof to Nick. When Nick was unable to refute Jack's (<i><a href="https://www.logicallyfallacious.com/logicalfallacies/Unfalsifiability" target="fallacy" data-toggle="tooltip" title="" data-original-title="Confidently asserting that a theory or hypothesis is true or false even though the theory or hypothesis cannot possibly be contradicted by an observation or the outcome of any physical experiment, usually without strong evidence or good reasons.">unfalsifiable</a></i>) claim, Jack claimed victory.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Audrey is making a claim of common knowledge, perhaps sparked by Fred's suspicions. Fred is asking Audrey to prove the claim when he is the one that should be justifying his objection to the claim of common knowledge.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Again, the question of who has the burden of proof is not always as simple as demonstrated in these examples. Often, this is an argument itself.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If possible, justify your argument with evidence even if you might not have the burden of proof. The only time you might not want to do this is when it gives credibility to an outrageous accusation or claim.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Bunnin, N., &amp; Yu, J. (2008). <i>The Blackwell Dictionary of Western Philosophy</i>. John Wiley &amp; Sons.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Presenting information in a deceptive way that results in others interpreting the information in such a way that does not reflect reality but is how you want the information to be interpreted.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Very often, people's ideas of God are a result of their values, not the other way around. This is made clear by the cultural shifts on moral issues that correlate with people's interpretation of the Bible (one example being <a href="http://www.pewresearch.org/fact-tank/2015/12/18/most-u-s-christian-groups-grow-more-accepting-of-homosexuality/">Christian's views on homosexuality</a>). Bret may genuinely believe his narrative, but it was most likely a result of the spin doctoring of another person or organization.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;They are situations where there is no objective truth to a view and data can be looked at in multiple ways, such as the classic &quot;is the glass half-full or half-empty&quot; question.
    </p>
    <p class="Body">
      <strong>Tip: </strong>Consider the source's biases. This will help with detecting spin doctoring.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;&nbsp;Accepting the truth of a claim based on a conversion story without considering any evidence for the truth of the claim.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          MAC, M. J. T., PhD, CSAC. (2006). <i>Critical Thinking for Addiction Professionals</i>. Springer Publishing Company.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <div class="content clearfix">
      <p class="Body">
        <strong>Description:</strong>&nbsp;The general beliefs that we use to categorize people, objects, and events while assuming those beliefs are accurate generalizations of the whole group.
      </p>
      <p class="Body">
        <strong>Logical Form:</strong>
      </p>
      ...
      <p>
        <strong>Tip:</strong>&nbsp;Remember that people are individuals above being members of groups or categories.
      </p>
    </div>
  </body>
</html>
...
<node TEXT="Blinding with science" ID="ID_1514720926" CREATED="1642350717782" MODIFIED="1642350728408"/>
<node TEXT="Runaway train" ID="ID_474141963" CREATED="1642361217429" MODIFIED="1642361221059"/>
<node TEXT="Shifting ground" ID="ID_1743083255" CREATED="1642361529218" MODIFIED="1642361533695"/>
<node TEXT="Thatcher’s blame" ID="ID_44825494" CREATED="1642361648053" MODIFIED="1642361649102"/>
<node TEXT="Unaccepted enthyrnemes" ID="ID_1418095432" CREATED="1642362203743" MODIFIED="1642362209656"/>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Concluding that an idea or proposition is true or false because the consequences of it being true or false are desirable or undesirable.&nbsp;&nbsp;The fallacy lies in the fact that the desirability is not related to the truth value of the idea or proposition.&nbsp;&nbsp;This comes in two forms: the positive and negative.&nbsp;

    <p class="Body">
      <strong>Logical Forms: </strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is true because if people did not accept X as being true then there would be negative consequences.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is false because if people did not accept X as being false, then there would be negative consequences.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is true because accepting that X is true has positive consequences.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is false because accepting that X is false has positive consequences.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1 (positive):</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>If there is objective morality, then good moral behavior will be rewarded after death.&nbsp;&nbsp;I want to be rewarded; therefore, morality must be objective.</em></font>
    </p>
    <p class="Body">
...
<node TEXT="Appeal to force" ID="ID_1665697231" CREATED="1618490223870" MODIFIED="1642755709784">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;&nbsp;When force, coercion, or even a threat of force is used in place of a reason in an attempt to justify a conclusion.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Melvin has asked a legitimate question to which he did not get a legitimate answer, rather his question was deflected by a threat of force (as being forced out of his job).
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Unless you are an indentured servant (slave) or still living with your parents (slave), do not allow others to force you into accepting something as true.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When the desire for something to be true is used in place of/or as evidence for the truthfulness of the claim.&nbsp;&nbsp;Wishful thinking, more as a cognitive bias than a logical fallacy, can also cause one to evaluate evidence very differently based on the desired outcome.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Andolina, M. (2002). <i>Practical Guide to Critical Thinking</i>. Cengage Learning.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Attempting to broaden the criteria for inclusion in an ill-famed group or associated with a negative label to the point where the term's definition is changed substantially to condemn or criminalize a far less malicious or deleterious behavior.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Presenting the testimony of a source that is not an eyewitness to the event in question.&nbsp;&nbsp;It has been conclusively demonstrated that with each passing of information, via analog transmission, the message content is likely to change.&nbsp;&nbsp;Each small change can and often does lead to many more significant changes, as in the <i>butterfly effect</i>&nbsp;in<i>&nbsp;chaos theory</i>.

    <p class="Body">
      Hearsay is generally considered very weak evidence if it is considered evidence at all.&nbsp;&nbsp;Especially when such evidence is <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Unfalsifiability" target="fallacy" data-toggle="tooltip" title="" data-original-title="Confidently asserting that a theory or hypothesis is true or false even though the theory or hypothesis cannot possibly be contradicted by an observation or the outcome of any physical experiment, usually without strong evidence or good reasons.">unfalsifiable</a></i>&nbsp;&nbsp;(not able to be proven false).
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Lolita is making a bold claim about Bill, based on hearsay.&nbsp;&nbsp;Not only did Lolita not see Bill steal the money, but neither did Diane, Julian, and who knows about Morris.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;When you trust the source, and trust that the source is accurately representing the facts, you can at least partially accept the claim, depending on the consequences of accepting or rejecting the claim.&nbsp;&nbsp;For example, if your best friend told you that her best friend told her about an amazing one day sale at the mall, risking a 10-minute drive to the mall might be justified based on the sources.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;People are often egregiously wrong in their interpretation of events.&nbsp;&nbsp;As time passes, imagination is confused with actual events.&nbsp;&nbsp;You might be able to trust that your best friend is telling you the truth, but only the truth so far as she recalls from her initial interpretation.
    </p>
    <p>
      <strong>Variation:</strong>&nbsp;The <i>anecdotal fallacy</i>, or V<i>olvo fallacy</i>, is allowing a specific instance of anecdotal evidence to lend much more weight to an argument than it should.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When only select evidence is presented in order to persuade the audience to accept a position, and evidence that would go against the position is withheld.&nbsp;&nbsp;The stronger the withheld evidence, the more fallacious the argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Resumes are a classic example of <i>cherry picking</i>&nbsp;&nbsp;information.&nbsp;&nbsp;A resume can be seen as an argument as to why you are qualified for the job.&nbsp;&nbsp;Most employers are wise enough to know that resumes are one-sided and look for more evidence in the form of interviews and recommendations to make a decision.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This is best summed up as &quot;dead men don't tell tales.&quot; In its general form, the survivorship fallacy is basing a conclusion on a limited number of &quot;winner&quot; testimonies due to the fact we cannot or do not hear the testimonies of the losers. This is based on the cognitive bias called the <i>survivorship bias</i>.
    ...
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      Day 1: Five different stocks are chosen, and each stock is sent to 2 million people as the winning pick. Let's say three of those stocks make money, and two don't. The 4 million people who received the stock pick that lost money are removed from the list (kind of like dying).<br/><br/>Day 2: Another 5 stocks are chosen. This time, each stock is only sent to the &quot;survivors,&quot; about 1.2 million people each get a new pick. Out of that group, perhaps just two stocks are winners. That means that 2.4 million people got the winning stock: two days in a row! You can see where this is headed...<br/><br/>...<br/><br/>Day 7: After the final day of sending, about 100,000 &quot;survivors&quot; remain on the list. These are people who have been sent the winning picks 7 days in a row and are convinced that the &quot;investor&quot; must be legitimate. After all, what are the chances that anyone would pick 7 winning stocks in a row with that much confidence?
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When a decision is based solely on quantitative observations (i.e., metrics, hard data, statistics) and all qualitative factors are ignored.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
      Measure whatever can be easily measured.<br/>Disregard that which cannot be measured easily.<br/>Presume that which cannot be measured easily is not important.<br/>Presume that which cannot be measured easily does not exist.
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;While the numbers on gun violence are alarming, we can't ignore the qualitative benefits of gun ownership. When making a decision, all factors need to be considered, even if they cannot be measured quantitatively.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;It is possible that certain decisions do not have any qualitative components, or the qualitative components are irrelevant. For example, very often salespeople or high-end stores will attempt to sell us overpriced products or services that we can get elsewhere for 1/2 the price. They might justify their higher prices with &quot;service,&quot; where nobody needs &quot;service&quot; when buying toilet paper.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Qualitative factors are often measured with a degree of subjectivity, meaning that one might give different moral weight to an idea based on one's core values. Consider this before being too harsh in your judgment of others' political or religious views.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Assuming things that are often grouped together must always be grouped together, or the assumption that the ungrouping will have significantly more severe effects than anticipated.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Michael Jackson was sure great in the <i>Jackson Five</i>, but as history proves, he was legendary on his own.&nbsp;&nbsp;Assuming he would not make it on his own is a judgment call not founded on evidence or reason.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This was a common argument against the banning of indoor smoking for bars and other drinking establishments.&nbsp;&nbsp;The fear of separating smoking and drinking arose from the fear of going out of business, not from statistical data or any other evidence that would normally be deemed reasonable.&nbsp;&nbsp;Many years later, it appears that the smoking ban had no significant impact on these kinds of establishments.<a title="" href="http://www.logicallyfallacious.com/index.php/logical-fallacies/140-package-deal-fallacy#_ftn1"><sup>[1]</sup></a>
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <p>
        <a title="" href="http://www.logicallyfallacious.com/index.php/logical-fallacies/140-package-deal-fallacy#_ftnref"><sup>[1]</sup></a>&nbsp;Mark Engelen, Matthew Farrelly &amp; Andrew Hyland: The Health and Economic Impact of New York's Clean Indoor Air Act. July 2006, p. 21
      </p>
    </div>
  </body>
</html>
...
<node TEXT="Weak Analogy" ID="ID_1445512070" CREATED="1618489731854" MODIFIED="1642767503043"><richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When an analogy is used to prove or disprove an argument, but the analogy is too dissimilar to be effective, that is, it is unlike the argument more than it is like the argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is an actual analogy used by a Christian debater (one who usually appears to value reason and logic).&nbsp;&nbsp;There are several problems with this analogy, including:
    </p>
    <ul>
      <li>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is a common analogy used by some atheists who argue against Christianity.&nbsp;&nbsp;It is a <i>weak analogy</i>&nbsp;because:
    </p>
    <ul>
      <li>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Luckhardt, C. G., &amp; Bechtel, W. (1994). <i>How to Do Things with Logic</i>. Psychology Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is an even worse analogy. The accomplishments of NASA are independent of our personal accomplishments.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;If the argument is for getting a man on the moon again, then this would work.
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_22427007" STARTINCLINATION="2918;0;" ENDINCLINATION="2918;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description: </strong>Concluding that a result is due to chance when the evidence strongly suggests otherwise.&nbsp;&nbsp;The <i>appeal to luck</i>&nbsp;&nbsp;variation uses luck in place of coincidence or chance.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Dwight is a trouble-maker -- that is quite clear.&nbsp;&nbsp;Rather than face the facts, he is <i>appealing to</i>&nbsp;<i>coincidence </i>by suggesting he just gets caught more often due to bad timing.
    </p>
    <p>
      <strong>Exception:</strong>&nbsp;Coincidences do happen.&nbsp;&nbsp;When the evidence points in the direction of coincidence, the coincidence might be the best option.
    </p>
    <p>
      <strong>Tip:</strong>&nbsp;Remember that million-to-one thing happened to you? It was probably a coincidence. Given how many things happen to us every day, all of us should experience many million-to-one events throughout our lifetimes.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A generalization that is technically accurate, but has one or more qualifications which eliminate so many cases that the resulting argument is significantly weaker than the arguer implies.&nbsp;&nbsp;In many cases, the listed exceptions are given in place of evidence or support for the claim, not in addition to evidence or support for the claim.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Besides being a <i>self-refuting statement</i>, the listing of the ways religion does not poison everything, is a clear indicator that the claim is false, or at best, very weak.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;We have many reasons supporting the opposite claim -- that this country is in great shape still, or at least that it is not in <i>terrible</i>&nbsp;&nbsp;shape.&nbsp;&nbsp;By the time all the reasons are listed, the original claim of our country being in terrible shape is a lot less agreeable.
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Drawing a conclusion based on a small sample size, rather than looking at statistics that are much more in line with the typical or average situation.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;It turns out that only five dentists were actually asked.&nbsp;&nbsp;When a random sampling of 1000 dentists was polled, only 20% actually recommended the brand.&nbsp;&nbsp;The four out of five result was not necessarily a <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Biased-Sample-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Drawing a conclusion about a population based on a sample that is biased, or chosen in order to make it appear the population on average is different than it actually is.">biased sample</a></i>&nbsp;or a dishonest survey; it just happened to be a statistical anomaly common among small samples.
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Hurley, P. J. (2011). <i>A Concise Introduction to Logic</i>. Cengage Learning.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Drawing a conclusion without taking the needed time to evaluate the evidence or reason through the argument.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Little or no evidence is provided or reviewed.</em></font><br/><font color="rgb(52, 73, 94)"><em>Conclusion is made.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;There are many times when quick decisions are required, and evidence cannot be fully examined, and in such circumstances, we need to come to the best conclusion we can with the resources we have.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;If anyone gives you an unreasonable timeframe for making a decision, it is almost always an attempt to discourage you from critical thought.&nbsp;&nbsp;If you cannot have what you feel is a reasonable amount of time to come to a well-reasoned conclusion -- walk away.
    </p>
  </body>
</html>
</richcontent>
<node TEXT="Mind reading" ID="ID_1161120704" CREATED="1637246884916" MODIFIED="1637246885604"/>
...
<node TEXT="Ex-post-facto Statistics" ID="ID_76495693" CREATED="1642351863523" MODIFIED="1642351875252"/>
</node>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_860419904" STARTINCLINATION="457;104;" ENDINCLINATION="425;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="NOTE">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A small number of dramatic and vivid events are taken to outweigh a significant amount of statistical evidence.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Nisbett, R. E., &amp; Ross, L. (1980). <i>Human inference: strategies and shortcomings of social judgment</i>. Prentice-Hall.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1706945405" STARTINCLINATION="761;-19;" ENDINCLINATION="763;-19;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
</node>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When a conclusion is assumed not because it is probably true or it has not been demonstrated to be impossible, but because it is <i>possible</i>&nbsp;&nbsp;that it is true, no matter how improbable.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Sharing an article, post, or meme on social media with the intent to influence public perception to perceive a statistically rare event as a common event. The cognitive bias behind this fallacy is the <em>availability heuristic</em>&nbsp;that causes us to have a skewed perception of reality based on specific examples that easily come to mind.

    <p class="Body">
      Like most fallacies, we have the fallacious tactic by the one who shares an article, post, or meme on social media depicting a statistically rare event with the intent to manipulate public perception of the event as a common event. Someone who views an article, post, or meme on social media depicting a statistically rare event and believes it to be a common event, has been a victim of <em>deceptive sharing</em>&nbsp;and is using fallacious reasoning. It is also possible for those sharing content to be deceived, themselves.
    </p>
    <p class="Body">
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>[fallacious tactic]</em></font><br/><font color="rgb(52, 73, 94)"><em>Event X is statistically rare.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 shares article, post, or meme of an instance of event X with the intent to deceive others in thinking event X is far more common than it is.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>[fallacious reasoning]</em></font><br/><font color="rgb(52, 73, 94)"><em>Event X is statistically rare.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 shares article, post, or meme of an instance of event X.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 2 believes the event is far more common than it is.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Event X is statistically rare.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 shares article, post, or meme of an instance of event X, believing that event X is far more common than it is.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1: </strong>During the COVID-19 pandemic, there was much debate on reopening schools. Like with many issues, there was a strong partisan split where liberals were mostly against sending kids back to school, and conservatives were mostly for sending kids back to school. Several of my liberal friends commonly shared stories about kids getting sick, including this story posted with no comment nor argument:
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Health officials in Georgia confirmed this week that a 7-year-old boy with no underlying health conditions has died from the coronavirus, the youngest fatality from the pandemic in the state so far.</em></font>
    </p>
    <p class="Body">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Drawing a conclusion about a population based on a sample that is biased, or chosen in order to make it appear the population on average is different than it actually is.

    <p class="Body">
      This differs from the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Hasty-Generalization" target="fallacy" data-toggle="tooltip" title="" data-original-title="Drawing a conclusion based on a small sample size, rather than looking at statistics that are much more in line with the typical or average situation.">hasty generalization</a></i>&nbsp;fallacy, where the biased sample is specifically chosen from a select group, and the small sample is just a random sample, but too small to get any accurate information.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Where did these homeowners live?&nbsp;&nbsp;Beverly Hills, CA.&nbsp;&nbsp;If the same survey was taken in Detroit, the results would be quite different.&nbsp;&nbsp;It is fallacious to accept the conclusion about the American population in general based on not just the geographical sample, but also the fact that homeowners were only surveyed.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This can be seen as an entire class of fallacies that result in presenting statistical data in a very biased way, and of course, interpreting statistics without questioning the methods behind collecting and presenting the data.

    <p class="Body">
      The many methods are outside the scope of this book, but if you really want to jump in here, and see how deceptive statistics can be, get the book, <i>How to Lie with Statistics</i>&nbsp;by Darrell Huff, a 1954 classic that is just as relevant today as it was in his time.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Huff, D. (1993). <i>How to Lie with Statistics</i>&nbsp;(Reissue edition). New York: W. W. Norton &amp; Company.
        </div>
      </div>
    </div>
  </body>
...
<node TEXT="Damning the Alternatives" ID="ID_533011592" CREATED="1642351409710" MODIFIED="1642351412926"/>
<node TEXT="Exception that proves the rule" ID="ID_1386270026" CREATED="1642351757452" MODIFIED="1642351761637"/>
</node>
<node TEXT="Accident Fallacy" POSITION="left" ID="ID_1729055530" CREATED="1618489377661" MODIFIED="1642678460482"><richcontent TYPE="DETAILS">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_841086237" STARTINCLINATION="1819;0;" ENDINCLINATION="1819;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Inferring that something is true of the whole from the fact that it is true of some part of the whole.&nbsp;&nbsp;This is the opposite of the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Fallacy-of-Division" target="fallacy" data-toggle="tooltip" title="" data-original-title="Inferring that something is true of one or more of the parts from the fact that it is true of the whole.  This is the opposite of the fallacy of composition.">fallacy of division</a></i>.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I included three examples that demonstrate this fallacy from the very obvious to the less obvious, but equally as flawed.&nbsp;&nbsp;In the first example, it is obvious because weight is cumulative.&nbsp;&nbsp;In the second example, we know that water is wet, but we only experience the property of wetness when the molecules are combined and in large scale.&nbsp;&nbsp;This introduces the concept of <i>emergent properties</i>, which when ignored, tends to promote <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Magical-Thinking" target="fallacy" data-toggle="tooltip" title="" data-original-title="Making causal connections or correlations between two events not based on logic or evidence, but primarily based on superstition.  Magical thinking often causes one to experience irrational fear of performing certain acts or having certain thoughts because they assume a correlation with their acts and threatening calamities.">magical thinking</a></i>.&nbsp;&nbsp;The final example is a common argument made for a supernatural explanation for consciousness.&nbsp;&nbsp;On the surface, it is difficult to imagine a collection of molecules resulting in something like consciousness because we are focusing on the properties of the parts (molecules) and not the whole system, which incorporates emergence, motion, the use of energy, temperature (vibration), order, and other <i>relational properties</i>.
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Goodman, M. F. (1993). <i>First Logic</i>. University Press of America.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Inferring that something is true of one or more of the parts from the fact that it is true of the whole.&nbsp;&nbsp;This is the opposite of the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Fallacy-of-Composition" target="fallacy" data-toggle="tooltip" title="" data-original-title="Inferring that something is true of the whole from the fact that it is true of some part of the whole.  This is the opposite of the fallacy of division.">fallacy of composition</a></i>&nbsp;
    ...
    <p class="Body">
      <strong>Tip: </strong>Review the fallacy of composition and see if you understand the difference well-enough to explain it to someone.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;The interpretation of statistical data where inferences about the nature of individuals are deduced from inference for the group to which those individuals belong.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The fact that men score better on math than women is a group generalization. This does not mean that any individual man will score better than any individual woman on math. Educated guesses could be made if we knew more about the statistics. For example, if we just knew that men scored an average of 8% higher than women, we could not even say that any given man is likely to be better at math than any given woman. This is because there could be what is referred to as an uneven distribution, that is, there could be a small group of women who are really bad at math or a small group of men who are really good at math that throws off the curve.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    <p class="Body">
      A study was done recently showing that church attendance was positively correlated with marriage longevity, that is, those couples who attended church together more often were more likely to stay married. This really should not be a surprise considering the general view of divorce within religion. <strong>What this does not mean is that any given couple who does not attend church is more likely to get divorced than any given couple that does attend church.</strong>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;To make this claim, we would need more information on the raw data used. Perhaps just religious fanatics who go to church daily have a practically non-existent divorce rate of say 2%. Then it is possible that those who never go to church have a lower divorce rate than those who do go to church every Sunday, but because of the fanatics, the distribution is not evenly distributed.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;It is not unreasonable to make a probabilistic claim about any given member of a group if the data warrants such a claim. For example, if 999 jellybeans in a jar are red and one is green, we can say that any given jellybean in the jar is &nbsp;99.9% likely to be red.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;Although this is a statistical fallacy, it is commonly extended to everyday situations. If you don't mind getting into statistics a bit, understanding statistical fallacies could improve one's overall reasoning ability.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Babbie, E. R. (2016). <i>The Basics of Social Research</i>. Cengage Learning.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1741718067" STARTINCLINATION="2085;0;" ENDINCLINATION="2081;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A type of reasoning in which the proposition is supported by the premises, which is supported by the proposition, creating a circle in reasoning where no useful information is being shared.&nbsp;&nbsp;This fallacy is often quite humorous.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;<a href="https://youtu.be/GFD2ggNxR1g?t=133" target="_blank" rel="noopener">This example</a>&nbsp;is from a favorite movie of mine, <i>Idiocracy, </i>where Pvt. Joe Bowers (played by Luke Wilson) is dealing with a bunch of not-very-smart guys from the future.&nbsp;&nbsp;Joe is not getting any useful information about electrolytes, no matter how hard he tries.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Do your best to avoid circular arguments, as it will help you reason better because better reasoning is often a result of avoiding circular arguments.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When the argument is self-contradictory and cannot possibly be true.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Claim X is made, which is impossible as demonstrated by all or part of claim X.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>The only thing that is certain is uncertainty.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Uncertainty itself cannot be certain by definition.&nbsp;&nbsp;It is a self-contradiction.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p>
      <strong>Fun Fact:</strong>&nbsp;This sentence is false.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Making (usually) multiple, contradicting arguments, in an attempt to support a single point or idea.
    ...
    <p class="Body">
      In an example used by Sigmund Freud in <i>The Interpretation of Dreams</i>, a man accused by his neighbor of having returned a kettle in a damaged condition offered three arguments:
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      That he had returned the kettle undamaged;<br/>That it was already damaged when he borrowed it;<br/>That he had never borrowed it in the first place.
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Each statement contradicts the one before. If it was already damaged, how did he return it undamaged? If he never borrowed it, how was it already damaged when he borrowed it?
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;There are multiple statements here that all contradict, stemmed from the idea that the person does not believe in God. If he or she does not believe in God, how can he or she think God is evil? And if there is no such thing as evil, how can something be evil?
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Freud, S. (1913). <i>The Interpretation of Dreams</i>. Macmillan.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <div class="content clearfix">
      <p class="Body">
        <strong>Description:</strong>&nbsp;Requiring the truth of the something that you are simultaneously trying to disprove.
      </p>
      <p class="Body">
        <strong>Logical Form:</strong>
      </p>
      <p class="Body" style="padding-left: 40px">
        <font color="rgb(52, 73, 94)"><em>Person 1 is attempting to disprove X.</em></font><br/><font color="rgb(52, 73, 94)"><em>X is required to disprove X.</em></font>
      </p>
      <p class="Body">
        <strong>Example #1:</strong>
      </p>
      <p style="text-align: left; padding-left: 40px">
        <font color="rgb(52, 73, 94)"><em>Reason and logic are not always reliable, so we should not count on it to help us find truth.</em></font>
      </p>
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Here we are using reason to disprove the validity of reason, which is unreasonable -- reasonably speaking.
      </p>
      <p class="Body">
        <strong>Example #2:</strong>
      </p>
      <p style="padding-left: 40px">
        <font color="rgb(52, 73, 94)"><em>Science cannot be trusted.&nbsp;&nbsp;It is a big conspiracy to cover up the truth of the Bible and the creation story.&nbsp;&nbsp;Besides, I saw fossils in the creation museum with humans and dinosaurs together, which proves science is wrong!</em></font>
      </p>
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;Geology is a branch of science.&nbsp;&nbsp;Using science (examining fossils through the science of geology) to disprove science is absurd, a contradiction and, therefore, a fallacy in reasoning.
      </p>
      <p class="Body">
        <strong>Exception:</strong>&nbsp;Intentional irony.
      </p>
      <p class="Body">
        <strong>Fun Fact:</strong>&nbsp;The <em>nofallacies fallacy</em>&nbsp;is the belief that fallacies don't exist (not really).
      </p>
    </div>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Peikoff, L. (1993). <i>Objectivism: The Philosophy of Ayn Rand</i>. Penguin.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The definition is not at all helpful because we used the same words in the term to define them.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Here we have two definitions that result in a slightly larger circle, but a circle nonetheless.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Many definitions are circular, but in the process of defining, there might be enough other information to help us understand the term.
    </p>
    <p class="Body uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Lavery, J., &amp; Hughes, W. (2008). <i>Critical Thinking, fifth edition: An Introduction to the Basic Skills</i>. Broadview Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;An argument that accounts for a phenomenon in terms of the very phenomenon that it is supposed to explain, which results in an infinite regress.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This fallacy creates an endless loop that actually explains nothing.&nbsp;&nbsp;It is fallacious reasoning to accept an explanation that creates this kind of endless loop that lacks any explanatory value.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation: </strong>This fallacy can be tricky because maybe it is true that aliens are responsible for spreading life, so the answers might be technically right, but the question implied is how life <i>ultimately</i>&nbsp;&nbsp;began, which this form of reasoning will not answer.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;There might be some exceptions that rely on high-level epistemology having to do with a large enough loop and validating feedback.&nbsp;&nbsp;The important question to ask is, does the explanation have any value and is the question being answered or deflected?
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;Several fallacies are a result of a lack of explanatory value. For example, the <em>homunculus fallacy</em>&nbsp;can be seen as a specific form of the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Failure-to-Elucidate" target="fallacy" data-toggle="tooltip" title="" data-original-title="When the definition is made more difficult to understand than the word or concept being defined.">failure to elucidate</a></i>.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Tulving, E. (2000). <i>Memory, Consciousness, and the Brain: The Tallinn Conference</i>. Psychology Press.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_860419904" STARTINCLINATION="2275;0;" ENDINCLINATION="2216;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Substituting facts and evidence with words that stir up emotion, with the attempt to manipulate others into accepting the truth of the argument.
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A question that has a presupposition built in, which implies something but protects the one asking the question from accusations of false claims.&nbsp;&nbsp;It is a form of misleading discourse, and it is a fallacy when the audience does not detect the assumed information implicit in the question and accepts it as a fact.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="text-align: left; padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Question X is asked that requires implied claim Y to be accepted before question X can be answered.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>How long can one survive without water?</em></font>
    </p>
    <p class="Body">
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Menssen, S., &amp; Sullivan, T. D. (2007). <i>The Agnostic Inquirer: Revelation from a Philosophical Standpoint</i>. Wm. B. Eerdmans Publishing.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Asking a question that cannot be answered with any sort of rational meaning. This is the textual equivalent of dividing by zero.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Question asked.</em></font><br/><font color="rgb(52, 73, 94)"><em>Question is meaningless.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Yngve, V., &amp; Wasik, Z. (2006). <i>Hard-Science Linguistics</i>. A&amp;C Black.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Using an ambiguous term in more than one sense, thus making an argument misleading.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Term X is used to mean Y in the premise.</em></font><br/><font color="rgb(52, 73, 94)"><em>Term X is used to mean Z in the conclusion.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p>
      <strong>Tip:</strong>&nbsp;When you suspect equivocation, substitute the word with the same definition for all uses and see if it makes sense.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Parry, W. T., &amp; Hacker, E. A. (n.d.). <i>Aristotelian Logic</i>. SUNY Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;An argument or claim in which two completely opposing arguments appear to be logically equivalent when in fact they are not. The confusion is often due to one shared characteristic between two or more items of comparison in the argument that is way off in the order of magnitude, oversimplified, or just that important additional factors have been ignored.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Both president Petutti and a mass murder share the characteristic that something they did resulted in the death of civilians. However, the circumstances, the level of responsibility, and the intent are significantly different for the president than the typical mass murder and ignoring these factors is unreasonable, thus makes the argument fallacious.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>&nbsp;Using the second amendment as justification to allow civilians to own nuclear submarines.
    </p>
    <p class="Body">
      <strong>Explanation: </strong>In this case, the first &quot;thing&quot; is the weapon as understood at the time the second amendment was passed. The second &quot;thing&quot; of comparison is the nuclear submarine, also a weapon, but one of significantly different magnitude. This example also introduces the difference between a legal justification and an argumentative one (see <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Appeal-to-the-Law" target="fallacy" data-toggle="tooltip" title="" data-original-title="When following the law is assumed to be the morally correct thing to do, without justification, or when breaking the law is assumed to be the morally wrong thing to do, without justification.">appeal to the law</a></i>).
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Like most fallacies, this is one of degree rather than kind. The order of magnitude can be debated. Some may exaggerate this order of magnitude claiming a fallacy where it would be unreasonable to do so.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Listen and read carefully. Often, people will make analogies and others will interpret them as claims of equivalence.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Appealing to an irrelevant, unqualified, unidentified, biased, or fabricated source in support of an argument (modern usage). Historical use of this fallacy was in the attribution of &quot;religious&quot; or &quot;spiritual&quot; experiences to outside &quot;higher&quot; sources rather than internal, psychological processes (see <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Fantasy-Projection" target="fallacy" data-toggle="tooltip" title="" data-original-title="Confusing subjective experiences, usually very emotionally charged, with objective reality, then suggesting or demanding that others accept the subjective experience as objective reality.">fantasy projection</a></i>).
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Don't falsify facts.&nbsp;&nbsp;If you get caught lying, you will almost certainly lose the argument, even if you are right.
    </p>
  </body>
</html>
</richcontent>
<node TEXT="Contextomy" ID="ID_815428204" CREATED="1618488807959" MODIFIED="1642689840761">
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1844366471" STARTINCLINATION="617;0;" ENDINCLINATION="617;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Removing a passage from its surrounding matter in such a way as to distort its intended meaning.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Trisha managed to twist the meaning of the candidate's story from one showing the candidate's strong moral character, to one where he is a criminal. Clearly, context is important.
    </p>
    <p class="Body">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1706945405" STARTINCLINATION="2149;0;" ENDINCLINATION="2149;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
</node>
</node>
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Flew, A. (1984). <i>A Dictionary of Philosophy: Revised Second Edition</i>. Macmillan.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1844366471" STARTINCLINATION="521;0;" ENDINCLINATION="521;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When the meaning of a word, sentence, or entire idea is interpreted differently by changing where the accent falls.<strong><br/></strong>

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="#34495e"><em>Claim is made with accent on word X giving claim meaning Y.</em></font><br/><font color="#34495e"><em>Claim is interpreted with accent on word A giving claim meaning B.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1: </strong>In the movie, <i>My Cousin Vinny</i>, Ralph Maccio's character, Bill, was interrogated for suspected murder. When the police officer asks him, &quot;At what point did you shoot the clerk?&quot; Bill replies in shock, &quot;<em><strong>I</strong></em>&nbsp;shot the clerk? <em><strong>I</strong></em>&nbsp;shot the clerk?&quot; Later in the film, the police officer reads Bill's statement as a confession in court, &quot;...and he said, 'I shot the clerk. I shot the clerk.'&quot;
    </p>
    <p class="Body">
      <strong>Explanation: </strong>In the movie, it appeared that the police officer did understand Bill's question as a confession. So it did not appear to be a fallacious tactic of the police officer, rather a failure of critical thought perhaps due to a strong confirmation bias (the officer was very confident that Bill was guilty, thus failed to detect the nuance in the question).
    </p>
    <p class="Body">
      <strong>Example #2: </strong>In the hilarious Broadway musical, <i>The Book of Mormon</i>, there is a musical number where one character is explaining how to bury &quot;bad thoughts&quot; by just &quot;turning them off&quot; (like a light switch). The character doing the explaining (in glorious song) is specifically explaining to the main character how to suppress gay thoughts when the main character's &quot;bad thoughts&quot; have nothing to do with being gay. After the instructions, the main character tries to make this clear by affirming, &quot;<i><strong>I'm</strong></i>&nbsp;not having gay thoughts,&quot; to which the other characters respond &quot;Hurray! It worked!&quot;
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The stress on the &quot;I'm&quot; was ignored and confused for &quot;Hey, I'm <i>not</i>&nbsp;having gay thoughts anymore!&quot; Although this was comedy it portrayed an argument.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Our biases can cause us to miss the vocal nuance. Listen actively and critically, and try not to jump to conclusions. And you cannot turn off gay thoughts like a light switch.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Brookes, T. (1979). <i>Guitar: an American life</i>. Grove Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Trying to make a scenario appear better or worse by comparing it to the best or worst case scenario.
    ...
    <p>
      <strong>Fun Fact: </strong>My first car was a crappy, 1972 Chevy Nova that I bought for $50 in my sophomore year in high school. This was when I first learned about correlation. Me driving that car was strongly correlated with my lack of female companions.
    </p>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When an argument contains both universal quantifiers and existential quantifiers (all, some, none, every) with different meanings, and the order of the quantifiers is reversed. This is a specific form of<i>&nbsp;<a href="https://www.logicallyfallacious.com/logicalfallacies/Equivocation" target="fallacy" data-toggle="tooltip" title="" data-original-title="Using an ambiguous term in more than one sense, thus making an argument misleading.">equivocation</a>.<br/></i>

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Quantifier X then quantifier Y.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, quantifier Y then quantifier X.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Everyone should do something nice for someone. I am someone, so everyone should do something nice for me!</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;We have a reversal of the quantifiers.<br/>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Everyone (quantifier X) should do something nice for someone (quantifier Y). I am someone (quantifier Y), so everyone (quantifier X) should do something nice for me!</em></font>
    </p>
    <p class="Body">
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;It really is a good idea to do something nice for someone.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Salmon, M. H. (2012). <i>Introduction to Logic and Critical Thinking</i>. Cengage Learning.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <p class="Body">
      <strong>Description:</strong>&nbsp;When the definition is made more difficult to understand than the word or concept being defined.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Cederblom, J., &amp; Paulsen, D. (2011). <i>Critical Reasoning</i>&nbsp;(7 edition). Boston, MA: Wadsworth Publishing.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;When a definition used is really an accurate definition from credible sources, regardless of the damage it might do to a position.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Do not accept definitions put forth by the opponent unless you researched your definition on your own, and agree.
    </p>
    <strong>References:</strong>
...
<node TEXT="Extensional Pruning" ID="ID_1728446184" CREATED="1642352028405" MODIFIED="1642352032238"/>
</node>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1558928662" STARTINCLINATION="5386;0;" ENDINCLINATION="5386;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<font BOLD="true"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When an unclear phrase with multiple definitions is used within the argument; therefore, does not support the conclusion.&nbsp;&nbsp;Some will say single words count for the ambiguity fallacy, which is really a specific form of a fallacy known as <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Equivocation" target="fallacy" data-toggle="tooltip" title="" data-original-title="Using an ambiguous term in more than one sense, thus making an argument misleading.">equivocation</a></i>.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Claim X is made.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Y is concluded based on an ambiguous understanding of X.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Using implausibly precise statistics to give the appearance of truth and certainty, or using a negligible difference in data to draw incorrect inferences.

    <p>
      <strong>Logical Forms:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Statistic X is unnecessarily precise and has probability A of being true.</em></font><br/><font color="rgb(52, 73, 94)"><em>Statistic X is interpreted as having probability A+B as being true.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Statistic X represents position A.</em></font><br/><font color="rgb(52, 73, 94)"><em>Statistic Y represents position B.</em></font><br/><font color="rgb(52, 73, 94)"><em>Statistic Y is insignificantly different from statistic X.</em></font><br/><font color="rgb(52, 73, 94)"><em>Position A is seen as significantly different from position B.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Tour Guide: This fossil right here is 120,000,003 years old.<br/>Guest: How do you know that?<br/>Tour Guide: Because when I started working here three years ago, the experts did some radiometric dating and told me that it was 120,000,000 years old.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Although more of a comedy skit than anything else, this demonstrates the fallacious reasoning by the tour guide in her assumption that the dates given to her were precise to the year.
    </p>
    <p class="Body">
      <strong>Example #2: </strong>
    </p>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_22427007" STARTINCLINATION="5490;0;" ENDINCLINATION="5490;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The type-token fallacy is committed when a word can refer to either a type (representing an abstract descriptive concept) or a token (representing an object that instantiates a concept) and is used in a way that makes it unclear which it refers to. This is a more specific form of the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Ambiguity-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="When an unclear phrase with multiple definitions is used within the argument; therefore, does not support the conclusion.  Some will say single words count for the ambiguity fallacy, which is really a specific form of a fallacy known as equivocation.">ambiguity fallacy</a></i>.

    <p>
      <strong>Logical Forms:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Reference to type is made.</em></font><br/><font color="rgb(52, 73, 94)"><em>Response refers to token.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Reference to token is made.</em></font><br/><font color="rgb(52, 73, 94)"><em>Response refers to type.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Salesperson: Toyota manufactures like four dozens of cars, so if you don't like this one you can see others.<br/>Prospect: I would have guessed they made closer to millions of cars.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;The salesperson was referring to the different types of cars (models) Toyota makes, not how many instances (or tokens) of each car were manufactured. By not specifically stating &quot;types of cars&quot; or &quot;models,&quot; the statement was ambiguous and unnecessarily confusing.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Wetzel, L. (2014). Types and tokens. In E. N. Zalta (Ed.), <i>The Stanford Encyclopedia of Philosophy</i>&nbsp;(Spring 2014). Metaphysics Research Lab, Stanford University. Retrieved from https://plato.stanford.edu/archives/spr2014/entriesypes-tokens/
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Variation:</strong>&nbsp;Staying true to the definitions, the <i>false dilemma</i>&nbsp;&nbsp;is different from the <i>false dichotomy</i>&nbsp;in that a dilemma implies two equally unattractive options whereas a dichotomy generally comprises two opposites. This is a fine point, however, and is generally ignored in common usage.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Moore, B. N., &amp; Parker, R. (1989). <i>Critical thinking: evaluating claims and arguments in everyday life</i>. Mayfield Pub. Co.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;Striving for perfection is not the same as the <i>nirvana fallacy</i>.&nbsp;&nbsp;Having a goal of perfection or near perfection, and working towards that goal, is admirable.&nbsp;&nbsp;However, giving up on the goal because perfection is not attained, despite major improvements being attained, is fallacious.
    </p>
    <p>
      <strong>Tip:</strong>&nbsp;Sometimes good enough is really good enough.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          <i>George Mason University law review</i>. (1991).
        </div>
      </div>
    </div>
  </body>
...
<node TEXT="Unobtainable perfection fallacy" ID="ID_818051913" CREATED="1642363259159" MODIFIED="1642363262612"/>
</node>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When a contributing factor is assumed to be the cause, or when a complex array of causal factors is reduced to a single cause. It is a form of simplistic thinking that implies something is either a cause, or it is not. It overlooks the important fact that, especially when referring to human behavior, causes are very complex and multi-dimensional.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      X is a contributing factor to Y.<br/>X and Y are present.<br/>Therefore, to remove Y, remove X.
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      P1. A sedentary lifestyle contributes to obesity.<br/>P2. People have become more sedentary in the last few decades.<br/>C. Therefore, the rise in obesity <strong>can be fixed</strong>&nbsp;by people getting more exercise.
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;We made the leap from &quot;contributes&quot; to &quot;can be fixed.&quot; At best, we can conclude that the problem of obesity can be <i>mitigated</i>&nbsp;&nbsp;by people getting more exercise.
    </p>
    <p class="Body">
      <strong>Example #3:</strong>
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      P1. Smoking has been empirically proven to cause lung cancer.<br/>C. Therefore, if we eradicate smoking, we will eradicate lung cancer.
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Even though it is reasonable to consider smoking a &quot;cause&quot; of lung cancer versus a &quot;contributing factor&quot; to lung cancer, assuming it is the <strong>only</strong>&nbsp;cause is fallacious.
    </p>
    <p class="Body">
      <strong>Tip: </strong>Establishing causality is extremely tricky. Unless you are stating an established fact, start using more probabilistic language such as &quot;contributes to,&quot; &quot;leads to,&quot; &quot;has been known to reduce the effects of,&quot; or similar language.
    </p>
...
<node ID="ID_1945424442" CREATED="1618489238662" MODIFIED="1642690742043"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Introducing alternatives when, in fact, there are none.&nbsp;&nbsp;This could happen when you have two mutually exclusive statements (<i>correlative conjunction</i>) presented as choices, and instead of picking one or the other, introduce a third -- usually as&nbsp;&nbsp;a distraction from having to choose between the two alternatives presented.&nbsp;
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Rocco was asking a simple question, and out of personal safety, Paulie was committing the fallacy of <i>denying the correlative</i>&nbsp;by offering up another option to a choice that only had two.&nbsp;&nbsp;If Paulie were smarter, he could not have committed the fallacy and saved his kneecaps, by honesty and a little negotiation:
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      Rocco:&nbsp;&nbsp;Do ya have the five grand you owe me or not?
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The attempt to redefine a <i>correlative</i>&nbsp;(one of two mutually exclusive options) so that one alternative encompasses the other, i.e. making one alternative impossible. The redefinition, therefore, makes the word it is redefining essentially meaningless.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Shafer-Landau, R. (2007). <i>Ethical Theory: An Anthology</i>. John Wiley &amp; Sons.
        </div>
      </div>
    </div>
  </body>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1429915355" STARTINCLINATION="185;0;" ENDINCLINATION="185;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<edge COLOR="#00007c"/>
...
<node TEXT="Half-Concealed Quantification" ID="ID_1155566140" CREATED="1642352120928" MODIFIED="1642352134976">
<node TEXT="Concealed Quantification" ID="ID_1315005366" CREATED="1642350918844" MODIFIED="1642350932067"/>
</node>
</node>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A fallacy of reversing the order of two quantifiers.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Everybody has <i>his or her own</i>&nbsp;brain, not one we all share.&nbsp;&nbsp;Although I have met many people who seem not to have their own brain.&nbsp;&nbsp;This form of reasoning is invalid; therefore, fallacious.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Remember that a quantifier is an expression (e.g. all, some) that indicates the scope of a term to which it is attached.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Cook, R. T. (2009). <i>A Dictionary of Philosophical Logic</i>. Edinburgh University Press.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Any form of a <i>categorical syllogism</i>&nbsp;in which the major term is distributed in the conclusion, but not in the major premise.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Neil, S. (1853). <i>The Art of Reasoning: A Popular Exposition of the Principles of Logic</i>. Walton &amp; Maberly.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Any form of a <i>categorical syllogism</i>&nbsp;in which the minor term is distributed in the conclusion, but not in the minor premise.
    ...
    <p>
      <strong>Fun Fact:</strong>&nbsp;The Catholic bible has 73 books, the Protestant bible only has 66.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;<i>Modal logic</i>&nbsp;studies ways in which propositions can be true or false, the most common being <i>necessity</i>&nbsp;and <i>possibility</i>.&nbsp;&nbsp;Some propositions are necessarily true/false, and others are possibly true/false.&nbsp;&nbsp;In short, a modal fallacy involves making a formal argument invalid by confusing the <i>scope</i>&nbsp;of what is actually necessary or possible.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>A conditional claim is made using a necessary truth.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, conclusion is reached that a possible truth is necessary with no conditional statement.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>If Barak is President, then he must be 35 years-old or older.</em></font>
    </p>
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Technically this is fallacious.&nbsp;&nbsp;There is no condition in which someone <i>necessarily</i>&nbsp;is a certain age.&nbsp;&nbsp;More accurately, we would say:
    </p>
    <p style="padding-left: 40px">
    ...
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;According to Article II of the U.S. Constitution, the president of the United States must be a natural-born citizen of the United States; be at least 35 years old; have been a resident of the United States for 14 years; and be able to identify a snake, an elephant, and an alligator.
    </p>
    <strong>References:</strong>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Curtis, G. N. (1993). <i>The Concept of Logical Form</i>. Indiana University.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A formal fallacy in a categorical syllogism where the <i>middle term</i>, or the term that does not appear in the conclusion, is not distributed to the other two terms.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;We are tricked because the conclusion makes sense, so out of laziness we accept the argument, but the argument is invalid, and by plugging in new terms, like in the next example, we can see why.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;While there may be ghosts that are unicorns, it does not follow from the premises: the only thing the premises tell us about ghosts and unicorns is that they are both imaginary -- we have no information how they are related to each other.
    </p>
    <p class="Body">
      <strong>Fun Fact:</strong>&nbsp;I have it on good authority that unicorns do poop rainbows.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Welton, J. (1896). <i>A Manual of Logic</i>. W. B. Clive.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Carlsen-Jones, M. T. (1983). <i>Introduction to Logic</i>. McGraw-Hill.
        </div>
      </div>
    </div>
  </body>
...
<header/>    
    ...
    <div class="content clearfix">
      ...
      <p class="Body">
        <strong>Description:</strong>&nbsp;The conclusion of a standard form categorical syllogism is negative, but both of the premises are positive.&nbsp;&nbsp;Any valid forms of categorical syllogisms that assert a negative conclusion must have at least one negative premise.
      </p>
      <p class="Body">
        <strong>Logical Form:</strong>
      </p>
      ...
      <p class="Body">
        <strong>Explanation:</strong>&nbsp;The conclusion might be true -- but the argument still does not logically support that for the same reasons in the first example.&nbsp;&nbsp;This argument is invalid, thus as a formal argument, it is fallacious.
      </p>
      <p class="Body">
        <strong>Fun Fact:</strong>&nbsp;I taught my pet rock how to play dead. It was its only trick.
      </p>
    </div>
    <strong>References:</strong>
...
<node TEXT="contradictory premises" ID="ID_1556403884" CREATED="1642351126612" MODIFIED="1642351129626"/>
<node TEXT="Quaternio terminorum" ID="ID_62140765" CREATED="1642352552130" MODIFIED="1642352557145"/>
</node>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Similar to the <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Disjunction-Fallacy" target="fallacy" data-toggle="tooltip" title="" data-original-title="Similar to the conjunction fallacy, the disjunction fallacy occurs when one estimates a disjunctive statement (this or that) to be less probable than at least one of its component statements.">disjunction fallacy</a></i>&nbsp;, the <em>conjunction fallacy</em>&nbsp;occurs when one estimates a conjunctive statement (this <em>and</em>&nbsp;&nbsp;that) to be more probable than at least one of its component statements. It is the assumption that more specific conditions are more probable than general ones.&nbsp;&nbsp;This fallacy usually stems from thinking the choices are alternatives, rather than members of the same set.&nbsp;&nbsp;The fallacy is further exacerbated by priming the audience with information leading them to choose the subset as the more probable option.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is a subset of Y.<br/>Therefore, X is more probable than Y.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Conjunction X and Y (both taken together) is more likely than a constituent X.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Kahneman, D. (2013). <i>Thinking, Fast and Slow</i>&nbsp;(1st edition). New York: Farrar, Straus and Giroux.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;This is incorrect.&nbsp;&nbsp;While it is very likely that Mr. Pius is Catholic based on the information, it is more likely that he is Catholic or Muslim.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Gilovich, T., Griffin, D., &amp; Kahneman, D. (2002). <i>Heuristics and Biases: The Psychology of Intuitive Judgment</i>. Cambridge University Press.
        </div>
      </div>
    </div>
  </body>
...
<node ID="ID_249917460" CREATED="1618487959453" MODIFIED="1637057038293"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I could have had more money to spend simply because I gave up crack-cocaine, prostitute solicitation, and baby-seal-clubbing expeditions.
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When the conclusion does not follow from the premises.&nbsp;&nbsp;In more informal reasoning, it can be when what is presented as evidence or reason is irrelevant or adds very little support to the conclusion.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I bet Phil makes one heck of a burger, but it does not follow that he should be president.
    </p>
    <p class="Body">
      <strong>Exception:</strong>&nbsp;There really are no exceptions to this rule. Any good argument must have a conclusion that follows from the premises.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;One of the best ways to expose non sequiturs is by constructing a valid analogy that exposes the absurdity in the argument.
    </p>
    <p class="Body">
      <strong>Variations:</strong>&nbsp;There are many forms of non sequiturs including <i>argument by scenario</i>, where an irrelevant scenario is given in an attempt to support the conclusion.&nbsp;&nbsp;Other forms use different rhetorical devices that are irrelevant to the conclusion.
    </p>
    <p class="Body">
      <i>False</i>&nbsp;or <i>questionable premises</i>&nbsp;could be seen as errors in facts, but they can also lead to the conclusion not following, so just keep that in mind, as well.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;When incomprehensible jargon or plain incoherent gibberish is used to give the appearance of a strong argument, in place of evidence or valid reasons to accept the argument.
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;I have no idea what I just wrote, and the audience will have no idea either -- but the audience (depending on who the audience is) will most likely make the assumption that I do know what I am talking about, believe that they are incapable of understanding the argument and therefore, agree with my conclusion since they think I do understand it.&nbsp;&nbsp;This is fallacious reasoning.
    </p>
    <p>
      <strong>Example #2:</strong>&nbsp;(The following was taken from the movie Spies Like Us where Emmett Fitz-Hume, played by Chevy Chase, was addressing the press.)
    </p>
    <p class="uk-margin-remove uk-text-primary" style="display: block; padding-left: 20px; font-style: italic">
    ...
    <p>
      <strong>Explanation:</strong>&nbsp;Emmett Fitz-Hume was clearly avoiding having to answer the question, and substituted gibberish for an answer. While the press was metaphorically scratching their heads to figure what what was just said, Emmett moved on without answering the question.
    </p>
    <p class="Body">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1429915355" STARTINCLINATION="655;0;" ENDINCLINATION="655;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Description:</strong>&nbsp;The conclusion of a standard form categorical syllogism is affirmative, but at least one of the premises is negative. Any valid forms of categorical syllogisms that assert a negative premise must have a negative conclusion.
    </p>
    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Exception:</strong>&nbsp;No exceptions as this is a formal fallacy.
    </p>
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Syllogisms and identifying formal fallacies (at least by form) are common on intelligence tests. Know this and be more intelligent (at least on paper).
    </p>
  </body>
</html>
</richcontent>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#ff0000" WIDTH="2" TRANSPARENCY="255" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1429915355" STARTINCLINATION="665;0;" ENDINCLINATION="665;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Tip:</strong>&nbsp;Learn to recognize the forms of formal fallacies, and you will easily spot invalid formal arguments.
    </p>
    <strong>References:</strong>
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#000000" WIDTH="2" TRANSPARENCY="200" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1558928662" STARTINCLINATION="40;0;" ENDINCLINATION="40;45;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
<richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;The assertion that a position is different from another position based on the language when, in fact, both positions are the same -- at least in practice or practical terms.

    <p class="Body">
      <strong>Logical Form:</strong>
    </p>
    <p class="Body" style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>Claim X is made where the truth of the claim requires a distinct difference between A and B.</em></font><br/><font color="rgb(52, 73, 94)"><em>There is no distinct difference between A and B.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, claim X is true.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A formal fallacy due to confusing the knowing of a thing (<i>extension</i>) with the knowing of it under all its various names or descriptions (<i>intension</i>).
    ...
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is Y.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 thinks X does Z.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, person 1 thinks Y did Z.</em></font>
    </p>
    <p style="padding-left: 40px">
      <font color="rgb(52, 73, 94)"><em>X is Y.</em></font><br/><font color="rgb(52, 73, 94)"><em>Person 1 thinks Y does Z.</em></font><br/><font color="rgb(52, 73, 94)"><em>Therefore, person 1 thinks X did Z.</em></font>
    </p>
    <p class="Body">
      <strong>Example #1:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Fun Fact: </strong>Julia Roberts really does own a Prius (at the time of this writing).
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;A formal fallacy in which the first premise states that at least one of the two <i>conjuncts</i>&nbsp;(antecedent and consequent) is false and concludes that the other conjunct must be true.
    ...
    <div class="small" style="padding-left: 22px; text-indent: -22px">
      ...
      <div class="csl-bib-body" style="line-height: 2; padding-left: 0; text-indent: 0">
        <div class="csl-entry">
          Kiersky, J. H., &amp; Caste, N. J. (1995). <i>Thinking Critically: Techniques for Logical Reasoning</i>. West Publishing Company.
        </div>
      </div>
    </div>
  </body>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Assuming that <i>implicature</i>&nbsp;means <i>implication</i>, when it logically does not.&nbsp; <i>Implicature</i>&nbsp;is a relation between the fact that someone makes a statement and a proposition.&nbsp; <i>Implication</i>&nbsp;&nbsp;is a relation between propositions, that is, the meanings of statements.
...
<html>
  ...
  <body>
    <ul style="border-top-style: none; border-top-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium; border-left-style: none; border-left-width: medium; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; font-weight: 400; line-height: normal; text-decoration: none; display: flex; width: 505px; list-style: square; color: rgb(0, 0, 0); font-family: RobotoMono, monospace; font-size: 14px; font-style: normal; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; word-spacing: 0px; background-color: rgb(255, 255, 255)">
      <li style="margin-left: 0; margin-bottom: 0">
        <font size="2" face="Dialog">(also known as: Fallacy of Predicate Logic, Fallacy of Quantificational Logic)</font>
      </li>
    </ul>
  </body>
</html>
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;This fallacy occurs in a categorical syllogism when the syllogism has four terms rather than the requisite three (in a sense, it cannot be a categorical syllogism to begin with!)&nbsp;&nbsp;If it takes on this form, it is invalid.&nbsp;&nbsp;The <i><a href="https://www.logicallyfallacious.com/logicalfallacies/Equivocation" target="fallacy" data-toggle="tooltip" title="" data-original-title="Using an ambiguous term in more than one sense, thus making an argument misleading.">equivocation</a></i>&nbsp;fallacy can also fit this fallacy because the same term is used in two different ways, making four distinct terms, although only appearing to be three.

    <p class="Body">
      <strong>Logical Form: </strong>There are many possible forms, this is one example:
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      All X are Y.
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;When you add in a fourth term to a categorical syllogism that can only have three terms to be logically valid, we get nonsense -- or at least an invalid argument.&nbsp;
    </p>
    <p class="Body">
      <strong>Example #2:</strong>
    </p>
    ...
    <p class="Body">
      <strong>Explanation:</strong>&nbsp;Again, nonsense.&nbsp;&nbsp;If we take away one of the terms, we end up with a valid syllogism:
    </p>
    <p class="uk-margin-remove uk-text-primary" style="padding-left: 20px; display: block; font-style: italic">
      All Greek gods are mythical.
    </p>
    ...
    <p class="Body">
      <strong>Fun Fact: </strong>Greek gods may not exist, but Greek yogurt does.
    </p>
  </body>
</html>
</richcontent>
...
<html>
  ...
  <body>
    ...
    <p>
      <strong>Tip:</strong>&nbsp;If you ever get confused with formal logic, replace the words with letters, like we do in the logical form, then replace the letters with different phrases and see if it makes sense or not.
    </p>
    <strong>References:</strong>
...
<html>
  ...
  <body>
    ...
    <p class="Body">
      <strong>Tip: </strong>Remember that formal fallacies are often obscured by unstructured rants. Creating a formal argument from such rants is both an art and a science.
    </p>
  </body>
</html>
</richcontent>
...
<node TEXT="Ad hoc rescue" POSITION="left" ID="ID_22427007" CREATED="1636979941740" MODIFIED="1642678608300"><richcontent TYPE="DETAILS">
...
<html>
  ...
  <body>
    <strong>Description:</strong>&nbsp;Very often we desperately want to be right and hold on to certain beliefs, despite any evidence presented to the contrary.&nbsp;&nbsp;As a result, we begin to make up excuses as to why our belief could still be true, and is still true, despite the fact that we have no real evidence for what we are making up.
