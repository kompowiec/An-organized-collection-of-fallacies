...
# Appeal to False Authority **Description:**  Using an alleged authority as evidence in your argument when the authority is not really an authority on the facts relevant to the argument. As the audience, allowing an irrelevant authority to add credibility to the claim being made. Also see the * *appeal to authority* * .
 **Logical Forms:** 
 ...
 **Tip:**  Impress your friends by telling them that there is no such fish species as a "red herring;" rather it refers to a particularly pungent fish—typically a herring but not always—that has been strongly cured in brine and/or heavily smoked.
 ...
 (see:argumentum ad hominemPhantom distinction)
...
# Appeal to Common Sense **Description:**  Asserting that your conclusion or facts are just “common sense” when, in fact, they are not. We must argue as to *why*  we believe something is common sense if there is any doubt that the belief is not common, rather than just asserting that it is. This is a more specific version of *alleged certainty* .
 **Logical Form:** 
...
### Science was wrong before
 (see:Argument of the Beard)
### Toupée fallacy
 (see:Survivorship FallacySpotlight fallacy)
### Appeal to eye
 ...
 **Description:**  Focusing your attention on certain aspects of the argument while completely ignoring or missing other parts.  This usually results in irrelevant rebuttals, *strawman fallacy* , and unnecessarily drawn-out arguments.
 **Logical Form:** 
...
Goodman, M. F. (1993). *First Logic* . University Press of America.
 ...
 (see:Faulty generalization/Inductive fallacies)
## Fallacy of division
 ...
 **Tip:** Remember that *begging the question*  doesn’t require a question, but the *complex question fallacy*  does.
 **References:** 
...
Flew, A. (1984). *A Dictionary of Philosophy: Revised Second Edition* . Macmillan.
 ...
 (see:Question-begging fallaciesAd hoc rescue)
 ...
 *George Mason University law review* . (1991).
 ...
 (see:Argument of the BeardAd hoc rescue)
 ...
 *Just about every Cambridge man working in the Foreign Office or s services in the late* 7 *940s has turned out to be a spy and a traitor. don’t we cut our losses, fire the rest, and not hire any more?* 
...
I *t is well known that members of the Campaign for Nuclear Disarmament are communists.* 
 ...
 **Tip:**  Take some time in your life to read a book or take a course on probability.  Probability affects our lives in so many ways that having a good understanding of it will continually pay off.
 ...
 (see:Faulty generalization/Inductive fallaciesFormal fallacies)
