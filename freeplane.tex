...
Appeal to the minority
  ...
  \subsubsection{Appeal to Definition
...
\subsubsection{Appeal to Common Belief
...
Appeal to censorship
  ...
  \subsubsection{Argument from incredulity
...
Junkyard tornado
  ...
  \subsection{Mind projection fallacy
...
Virtuality fallacy
  ...
  \subsection{Demonizing the enemy
...
Argumentum a simili
  ...
  \subsection{argumentum a fortiori
...
Argumentum ad exemplum
  ...
  \subsection{Argumentum ad vertiginem
...
Vacuous truth
  ...
  \subsection{Phantom distinction
